(function () {
	...
	const getNodeWithMinDistance = (Q, distances) => {
		...
		Object.keys(Q).forEach((key) => { // TODO: remove keys()
	...
	/**
	 * Return nodes and links in D3 Demo format
	 */
	function getNodes() {
		let demo_nodes = [], links = [];

		for (let v of V) {
			let o = {};
			o[v] = { 'group': 14 }; // What does this mean?
			demo_nodes.push(o);
		}

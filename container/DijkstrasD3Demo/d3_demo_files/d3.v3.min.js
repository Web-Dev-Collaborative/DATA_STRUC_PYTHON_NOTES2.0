!(function () {
  ...
  function g() {
    const n = [];
    for (const t in this._) n.push(s(t));
    return n;
  }
  function v() {
    let n = 0;
  ...
  function w(n) {
    function t(...args) {
      for (let t, r = e, i = -1, u = r.length; ++i < u; )
        (t = r[i].on) && t.apply(this, args);
      return n;
    }
    var e = [];
    const r = new c();
  ...
  function R(n, t) {
    ...
    function r(...args) {
      for (let e = -1, r = t.apply(this, args); ++e < i; ) n[e](this, r);
    }
    n = T(n).map(D);
    var i = n.length;
  ...
  function j(n) {
    function t() {
      const t = this.ownerDocument, e = this.namespaceURI;
  ...
  function Y(n, t) {
    for (let e = 0, r = n.length; r > e; e++)
      for (let i, u = n[e], o = 0, a = u.length; a > o; o++)
        (i = u[o]) && t(i, o, e);
    return n;
  }
  function Z(n) {
  ...
  function X(n, t, e) {
    ...
    function u() {
      let t;
      const e = new RegExp("^__on([^.]+)" + ao.requote(n) + "$");
      for (const r in this)
        if ((t = r.match(e))) {
          const i = this[r];
  ...
  function B(n, t) {
    const e = $(n, t);
    return function (n) {
      const t = this, r = n.relatedTarget;
      (r && (r === t || 8 & r.compareDocumentPosition(t))) || e.call(t, n);
    };
  }
  function W(e) {
    const r = ".dragsuppress-" + ++Do,
          i = "click" + r,
          u = ao
            .select(t(e))
            .on("touchmove" + r, S)
  ...
  function pn(n, t, e) {
    let r = (n + 16) / 116, i = r + t / 500, u = r - e / 200;
    return (
      (i = vn(i) * na),
      (r = vn(r) * ta),
      (u = vn(u) * ea),
  ...
  function wn(n, t, e) {
    let r;
    let i;
    const u = Math.min((n /= 255), (t /= 255), (e /= 255));
    const o = Math.max(n, t, e);
    const a = o - u;
    const l = (o + u) / 2;
    return (
      a
  ...
  function Sn(n, t, e) {
    ...
    const r = dn((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / na), i = dn((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / ta), u = dn((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / ea);
  ...
  function Cn(n, t, e, r) {
    ...
    var u = {};
    var o = ao.dispatch("beforesend", "progress", "load", "error");
    const a = {};
    ...
    ["get", "post"].forEach(n => {
      u[n] = function(...args) {
        return u.send(...[n].concat(co(args)));
      };
    }),
    (u.send = function (e, r, i) {
      if (
        ...
        for (const f in a) l.setRequestHeader(f, a[f]);
  ...
  function jn(n) {
    ...
    return n => {
      ...
      return n => {
        ...
        if (0 > _) {
          const w = m ? n.lastIndexOf("e") : -1;
          0 > w
            ? ((x = n), (b = ""))
            : ((x = n.substring(0, w)), (b = n.substring(w)));
        } else (x = n.substring(0, _)), (b = t + n.substring(_ + 1));
        !c && s && (x = u(x, 1 / 0));
        let S = v.length + x.length + b.length + (M ? 0 : i.length);
        const k = f > S ? new Array((S = f - S + 1)).join(r) : "";
        return (
  ...
  class Hn {
    constructor(...args) {
      this._ = new Date(
        args.length > 1 ? Date.UTC.apply(this, args) : args[0]
      );
    }
    ...
    setDate(...args) {
      da.setUTCDate.apply(this._, args);
    }

    setDay(...args) {
      da.setUTCDay.apply(this._, args);
    }

    setFullYear(...args) {
      da.setUTCFullYear.apply(this._, args);
    }

    setHours(...args) {
      da.setUTCHours.apply(this._, args);
    }

    setMilliseconds(...args) {
      da.setUTCMilliseconds.apply(this._, args);
    }

    setMinutes(...args) {
      da.setUTCMinutes.apply(this._, args);
    }

    setMonth(...args) {
      da.setUTCMonth.apply(this._, args);
    }

    setSeconds(...args) {
      da.setUTCSeconds.apply(this._, args);
    }

    setTime(...args) {
      da.setTime.apply(this._, args);
    }
  }
  ...
  function Yn(n) {
    function t(n) {
      ...
      var r = n.length;
      return (t.parse = t => {
        const r = { y: 1900, m: 0, d: 1, H: 0, M: 0, S: 0, L: 0, Z: null }, i = e(r, n, t, 0);
        if (i != t.length) return null;
        "p" in r && (r.H = (r.H % 12) + 12 * r.p);
        const u = null != r.Z && va !== Hn, o = new (u ? Hn : va)();
        return (
          "j" in r
    ...
    const s = n.dateTime, h = n.date, p = n.time, g = n.periods, v = n.days, d = n.shortDays, y = n.months, m = n.shortMonths;
    (t.utc = n => {
      function e(n) {
        try {
          va = Hn;
  ...
  function Zn(n, t, e) {
    const r = 0 > n ? "-" : "", i = (r ? -n : n) + "", u = i.length;
  ...
  function $n(n, t, e) {
    ma.lastIndex = 0;
    const r = ma.exec(t.slice(e, e + 1));
    return r ? ((n.w = +r[0]), e + r[0].length) : -1;
  }
  function Bn(n, t, e) {
    ma.lastIndex = 0;
    const r = ma.exec(t.slice(e));
  ...
  function Jn(n, t, e) {
    ma.lastIndex = 0;
    const r = ma.exec(t.slice(e, e + 4));
    return r ? ((n.y = +r[0]), e + r[0].length) : -1;
  }
  function Gn(n, t, e) {
    ma.lastIndex = 0;
    const r = ma.exec(t.slice(e, e + 2));
  ...
  function at(n) {
    const t = n.getTimezoneOffset(), e = t > 0 ? "-" : "+", r = (xo(t) / 60) | 0, i = xo(t) % 60;
  ...
  function vt() {
    function n(n, t) {
      (n *= Yo), (t = (t * Yo) / 2 + Fo / 4);
      const e = n - r, o = e >= 0 ? 1 : -1, a = o * e, l = Math.cos(t), c = Math.sin(t), f = u * c, s = i * l + f * Math.cos(a), h = f * o * Math.sin(a);
  ...
  function dt(n) {
    const t = n[0], e = n[1], r = Math.cos(e);
  ...
  function Nt() {
    function n(n, i) {
      n *= Yo;
      const u = Math.cos((i *= Yo));
      const o = u * Math.cos(n);
      const a = u * Math.sin(n);
      const l = Math.sin(i);
  ...
  function At() {
    function n(n, t) {
      n *= Yo;
      const e = Math.cos((t *= Yo)), o = e * Math.cos(n), a = e * Math.sin(n), l = Math.sin(t), c = i * l - u * a, f = u * o - r * l, s = r * a - i * o, h = Math.sqrt(c * c + f * f + s * s), p = r * o + i * a + u * l, g = h && -nn(p) / h, v = Math.atan2(h, p);
      (Da += g * c),
        (Pa += g * f),
        (Ua += g * s),
        (Aa += v),
    ...
    if (
      (n.forEach(n => {
        if (!((t = n.length - 1) <= 0)) {
          ...
          if (wt(e, r)) {
            i.lineStart();
            for (let a = 0; t > a; ++a) i.point((e = n[a])[0], e[1]);
            return void i.lineEnd();
          }
          let l = new Tt(e, n, null, !0), c = new Tt(e, null, l, !1);
          (l.o = c),
            u.push(l),
            o.push(c),
            (l = new Tt(r, n, null, !1)),
  ...
  function jt(n) {
    let t, e = NaN, r = NaN, i = NaN;
    return {
      lineStart() {
        n.lineStart(), (t = 1);
      },
      point(u, o) {
        const a = u > 0 ? Fo : -Fo, l = xo(u - e);
        xo(l - Fo) < Uo
  ...
  function Ot(n, t) {
    const e = n[0];
    const r = n[1];
    const i = [Math.sin(e), -Math.cos(e), 0];
    let u = 0;
    let o = 0;
    ka.reset();
    for (let a = 0, l = t.length; l > a; ++a) {
      const c = t[a], f = c.length;
      if (f)
        for (
          let s = c[0], h = s[0], p = s[1] / 2 + Fo / 4, g = Math.sin(p), v = Math.cos(p), d = 1;
          ;

        ) {
          d === f && (d = 0), (n = c[d]);
          const y = n[0], m = n[1] / 2 + Fo / 4, M = Math.sin(m), x = Math.cos(m), b = y - h, _ = b >= 0 ? 1 : -1, w = _ * b, S = w > Fo, k = g * M;
          if (
            (ka.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))),
            (u += S ? b + _ * Ho : b),
            S ^ (h >= e) ^ (y >= e))
          ) {
            const N = mt(dt(s), dt(n));
            bt(N);
            const E = mt(i, N);
            bt(E);
            const A = (S ^ (b >= 0) ? -1 : 1) * tn(E[2]);
            (r > A || (r === A && (N[0] || N[1]))) &&
              (o += S ^ (b >= 0) ? 1 : -1);
          }
          if (!d++) break;
  ...
  function It(n) {
    ...
    function e(n) {
      ...
      return {
        ...
        point(s, h) {
          ...
          const g = [s, h];
          let v = t(s, h);
          const d = o ? (v ? 0 : i(s, h)) : v ? i(s + (0 > s ? Fo : -Fo), h) : 0;
          if (
            (!e && (c = l = v) && n.lineStart(),
            v !== l &&
              ((p = r(e, g)),
    ...
    function r(n, t, e) {
      const r = dt(n), i = dt(t), o = [1, 0, 0], a = mt(r, i), l = yt(a, a), c = a[0], f = l - c * c;
      if (!f) return !e && n;
      const s = (u * l) / f, h = (-u * c) / f, p = mt(o, a), g = xt(o, s), v = xt(a, h);
      Mt(g, v);
      const d = p, y = yt(g, d), m = yt(d, d), M = y * y - m * (yt(g, g) - 1);
      if (!(0 > M)) {
        const x = Math.sqrt(M);
        let b = xt(d, (-y - x) / m);
        if ((Mt(b, g), (b = _t(b)), !e)) return b;
        let _, w = n[0], S = t[0], k = n[1], N = t[1];
        w > S && ((_ = w), (w = S), (S = _));
        const E = S - w, A = xo(E - Fo) < Uo, C = A || Uo > E;
        if (
          (!A && k > N && ((_ = k), (k = N), (N = _)),
          C
            ? A
    ...
    return a => {
      function l(n) {
        for (var t = 0, e = d.length, r = n[1], i = 0; e > i; ++i)
          for (let u, o = 1, a = d[i], l = a.length, c = a[0]; l > o; ++o)
            (u = a[o]),
              c[1] <= r
                ? u[1] > r && Q(c, u, n) > 0 && ++t
                : u[1] <= r && Q(c, u, n) < 0 && --t,
      ...
      var C = {
        ...
        polygonEnd() {
          (a = N), (v = ao.merge(v));
          const t = l([n, r]), e = k && t, i = v.length;
          (e || i) &&
            (a.polygonStart(),
  ...
  function Xt(n, t) {
    function e(n, t) {
      const e = Math.sqrt(u - 2 * i * Math.sin(t)) / i;
      return [e * Math.sin((n *= i)), o - e * Math.cos(n)];
    }
    const r = Math.sin(n);
    var i = (r + Math.sin(t)) / 2;
    var u = 1 + r * (2 * i - r);
    var o = Math.sqrt(u) / i;
    return (e.invert = (n, t) => {
      const e = o - t;
  ...
  function Kt() {
    function n(n, r) {
      const i = n - t, u = r - e, o = Math.sqrt(i * i + u * u);
      (qa += (o * (t + n)) / 2),
        (Ta += (o * (e + r)) / 2),
        (Ra += o),
        Gt((t = n), (e = r));
  ...
  function ee(n) {
    ...
    function i(t, e, r, a, l, c, f, s, h, p, g, v, d, y) {
      const m = f - t, M = s - e, x = m * m + M * M;
      if (x > 4 * u && d--) {
        let b = a + p;
        let _ = l + g;
        let w = c + v;
        const S = Math.sqrt(b * b + _ * _ + w * w);
        const k = Math.asin((w /= S));
  ...
  function ae(n) {
    ...
    function(...args) {
      return (u = n.apply(this, args)), (t.invert = u.invert && e), r();
    };
  }
  function le(n) {
    return ue(n, (t, e) => {
  ...
  function ge(n, t) {
    function e(n, t) {
      const e = Math.cos(t), a = Math.cos(n) * e, l = Math.sin(n) * e, c = Math.sin(t), f = c * r + a * i;
    ...
    var r = Math.cos(n),
      ...
      o = Math.sin(t);
    return (e.invert = (n, t) => {
      const e = Math.cos(t), a = Math.cos(n) * e, l = Math.sin(n) * e, c = Math.sin(t), f = c * u - l * o;
  ...
  function ye(n, t, e) {
    const r = ao.range(n, t - Uo, e).concat(t);
    return n => {
      return r.map(t => {
        return [n, t];
      });
  ...
  function be(n, t, e, r) {
    const i = Math.cos(t),
          ...
          g = h
            ? n => {
                const t = Math.sin((n *= h)) * p, e = Math.sin(h - n) * p, r = e * l + t * f, i = e * c + t * s, o = e * u + t * a;
                return [
                  Math.atan2(i, r) * Zo,
  ...
  function we(n, t) {
    function e(t, e) {
      const r = Math.cos(t), i = Math.cos(e), u = n(r * i);
      return [u * i * Math.sin(t), u * Math.sin(e)];
    }
    return (e.invert = (n, e) => {
      const r = Math.sqrt(n * n + e * e), i = t(r), u = Math.sin(i), o = Math.cos(i);
  ...
  function Se(n, t) {
    ...
    var o = (r * Math.pow(i(n), u)) / u;
    return u
      ? ((e.invert = (n, t) => {
          const e = o - t, r = K(u) * Math.sqrt(n * n + e * e);
          return [
            Math.atan2(n, e) / u,
  ...
  function ke(n, t) {
    ...
    const r = Math.cos(n);
    var i = n === t ? Math.sin(n) : (r - Math.cos(t)) / (t - n);
    var u = r / i + n;
    return xo(i) < Uo
      ? ce
      : ((e.invert = (n, t) => {
  ...
  function Ee(n) {
    ...
    const r = e.scale;
    const i = e.translate;
    const u = e.clipExtent;
    return (e.scale = function(...args) {
      const n = r.apply(e, args);
      return n === e ? (t ? e.clipExtent(null) : e) : n;
    }),
    (e.translate = function(...args) {
      const n = i.apply(e, args);
      return n === e ? (t ? e.clipExtent(null) : e) : n;
    }),
    (e.clipExtent = function (n) {
      let o = u.apply(e, arguments);
      if (o === e) {
        if ((t = null == n)) {
          const a = Fo * r(), l = i();
          u([
  ...
  function Re(n, t, e, r) {
    const i = n[0], u = e[0], o = t[0] - i, a = r[0] - u, l = n[1], c = e[1], f = t[1] - l, s = r[1] - c, h = (a * (l - c) - s * (i - u)) / (s * o - a * f);
    return [i + h * o, l + h * f];
  }
  function De(n) {
  ...
  function He(n) {
    ...
    if ((ol.insert(t, l), t || e)) {
      ...
      Be(t), Be(e);
      const c = t.site, f = c.x, s = c.y, h = n.x - f, p = n.y - s, g = e.site, v = g.x - f, d = g.y - s, y = 2 * (h * d - p * v), m = h * h + p * p, M = v * v + d * d, x = { x: (d * m - p * M) / y + f, y: (h * M - v * m) / y + s };
      nr(e.edge, c, g, x),
  ...
  function Oe(n, t) {
    ...
    if (!o) return -(1 / 0);
    e = o.site;
    const a = e.x, l = e.y, c = l - t;
    if (!c) return a;
    const f = a - r, s = 1 / u - 1 / c, h = f / c;
    return s
      ? (-h +
          Math.sqrt(
  ...
  function Ze(n) {
    for (
      let t, e, r, i, u, o, a, l, c, f, s = n[0][0], h = n[1][0], p = n[0][1], g = n[1][1], v = ul, d = v.length;
      d--;
  ...
  function $e(n) {
    const t = n.P, e = n.N;
    if (t && e) {
      const r = t.site, i = n.site, u = e.site;
      if (r !== u) {
        const o = i.x;
        const a = i.y;
        const l = r.x - o;
        ...
        const h = 2 * (l * s - c * f);
        if (!(h >= -jo)) {
          const p = l * l + c * c, g = f * f + s * s, v = (s * p - c * g) / h, d = (l * g - f * p) / h, s = d + a, y = fl.pop() || new Xe();
          (y.arc = n),
            (y.site = i),
            (y.x = v + o),
  ...
  function We(n) {
    for (
      let t, e = il, r = Yt(n[0][0], n[0][1], n[1][0], n[1][1]), i = e.length;
      i--;
  ...
  function pr(n, t, e, r, i, u) {
    if (!n(t, e, r, i, u)) {
      const o = 0.5 * (e + i), a = 0.5 * (r + u), l = t.nodes;
    ...
    return (function c(n, f, s, h, p) {
      if (!(f > u || s > o || r > h || i > p)) {
        if ((g = n.point)) {
          ...
          const y = v * v + d * d;
          if (l > y) {
            const m = Math.sqrt((l = y));
            (r = t - m), (i = e - m), (u = t + m), (o = e + m), (a = g);
          }
        }
        for (
          let M = n.nodes, x = 0.5 * (f + h), b = 0.5 * (s + p), _ = t >= x, w = e >= b, S = (w << 1) | _, k = S + 4;
          k > S;
          ++S
        )
          if ((n = M[3 & S]))
  ...
  function vr(n, t) {
    ...
    const e = n.r, r = n.g, i = n.b, u = t.r - e, o = t.g - r, a = t.b - i;
    return n => {
      return (
        "#" +
        bn(Math.round(e + u * n)) +
  ...
  function mr(n, t) {
    ...
    let r;
    let i;
    let u = (hl.lastIndex = pl.lastIndex = 0);
    let o = -1;
    const a = [];
    const l = [];
    ...
    a.length < 2
      ...
      : ((t = l.length),
        n => {
          for (let e, r = 0; t > r; ++r) a[(e = l[r]).i] = e.x(n);
          return a.join("");
        });
  }
  function Mr(n, t) {
  ...
  function xr(n, t) {
    ...
    const u = n.length;
    const o = t.length;
    const a = Math.min(n.length, t.length);
  ...
  function Lr(n, t) {
    let e;
    return arguments.length < 2 && (t = 0.45),
    arguments.length
  ...
  function Pr(n, t) {
    ...
    const e = n.l, r = n.a, i = n.b, u = t.l - e, o = t.a - r, a = t.b - i;
    return n => {
  ...
  function Yr(n, t, e, r) {
    if (n[0] !== t[0] || n[1] !== t[1]) {
      const i = e.push("translate(", null, ",", null, ")");
  ...
  function Xr(n, t, e, r) {
    if (n[0] !== t[0] || n[1] !== t[1]) {
      const i = e.push(Ir(e) + "scale(", null, ",", null, ")");
      r.push({ i: i - 4, x: yr(n[0], t[0]) }, { i: i - 2, x: yr(n[1], t[1]) });
  ...
  function $r(n, t) {
    ...
    (n = t = null),
    n => {
      for (let t, i = -1, u = r.length; ++i < u; ) e[(t = r[i]).i] = t.x(n);
      return e.join("");
    };
  }
  function Br(n, t) {
  ...
  function Jr(n) {
    for (var t = n.source, e = n.target, r = Kr(t, e), i = [t]; t !== r; )
      (t = t.parent), i.push(t);
    for (const u = i.length; e !== r; ) i.splice(u, 0, e), (e = e.parent);
    return i;
  }
  function Gr(n) {
  ...
  function ri(n, t, e) {
    ...
    if (((n.charge = 0), !n.leaf))
      for (let u, o = n.nodes, a = o.length, l = -1; ++l < a; )
        (u = o[l]),
          null != u &&
            (ri(u, t, e),
            (n.charge += u.charge),
  ...
  function ki(n, t) {
    const e = t.x - n.x, r = t.y - n.y, i = n.r + t.r;
  ...
  function Ci(n, t, e, r) {
    ...
    if (((n.x = t += r * n.x), (n.y = e += r * n.y), (n.r *= r), i))
      for (let u = -1, o = i.length; ++u < o; ) Ci(i[u], t, e, r);
  }
  function zi(n, t, e) {
    let r = n.r + e.r;
    const i = t.x - n.x;
  ...
  function Di(n) {
    for (let t, e = 0, r = 0, i = n.children, u = i.length; --u >= 0; )
  ...
  function Ii(n, t) {
    let e = n.x + t[3], r = n.y + t[0], i = n.dx - t[1] - t[3], u = n.dy - t[0] - t[2];
    return (
      0 > i && ((e += i / 2), (i = 0)),
      0 > u && ((r += u / 2), (u = 0)),
      { x: e, y: r, dx: i, dy: u }
  ...
  function Vi(n, t, e, r) {
    const i = e(n[0], n[1]), u = r(t[0], t[1]);
    return n => {
      return u(i(n));
    };
  }
  function Xi(n, t) {
    let e, r = 0, i = n.length - 1, u = n[r], o = n[i];
    return (
  ...
  function Bi(n, t, e, r) {
    ...
    const u = [];
    let o = 0;
    const a = Math.min(n.length, t.length) - 1;
    for (
    ...
    return t => {
      const e = ao.bisect(n, t, 1, a) - 1;
      return u[e](i[e](t));
    };
  }
  function Wi(n, t, e, r) {
    function i() {
      const i = Math.min(n.length, t.length) > 2 ? Bi : Vi, l = r ? Wr : Br;
  ...
  function Ki(n, t) {
    ...
    const e = Yi(n);
    const r = e[1] - e[0];
    let i = Math.pow(10, Math.floor(Math.log(r / t) / Math.LN10));
    const u = (t / r) * i;
    return (
  ...
  function nu(n, t, e) {
    ...
    if (e) {
      const i = ha.exec(e);
      if ((i.shift(), "s" === i[8])) {
        const u = ao.formatPrefix(Math.max(xo(r[0]), xo(r[1])));
  ...
  function ru(n, t, e, r) {
    ...
    (o.tickFormat = function (n, e) {
      ...
      const r = Math.max(1, (t * n) / o.ticks().length);
      return n => {
        let o = n / u(Math.round(i(n)));
  ...
  function ou(n, t) {
    ...
    function r(t, e) {
      return ao.range(n.length).map(n => {
        return t + e * n;
      });
    }
    var i;
    ...
    (e.rangeBands = function (i, a, l) {
      ...
      const c = i[1] < i[0], f = i[c - 0], s = i[1 - c], h = (s - f) / (n.length - a + 2 * l);
      return (
        (u = r(f + h * l, h)),
        c && u.reverse(),
        (o = h * (1 - a)),
    ...
    (e.rangeRoundBands = function (i, a, l) {
      arguments.length < 2 && (a = 0), arguments.length < 3 && (l = a);
      const c = i[1] < i[0], f = i[c - 0], s = i[1 - c], h = Math.floor((s - f) / (n.length - a + 2 * l));
      return (
  ...
  function mu(n, t, e, r, i) {
    const u = n[0] - t[0];
    const o = n[1] - t[1];
    const a = (i ? r : -r) / Math.sqrt(u * u + o * o);
    const l = a * o;
    const c = -a * u;
    const f = n[0] + l;
    const s = n[1] + c;
    ...
    const M = e - r;
    const x = f * p - h * s;
    const b = (0 > y ? -1 : 1) * Math.sqrt(Math.max(0, M * M * m - x * x));
    let _ = (x * y - d * b) / m;
    let w = (-x * d - y * b) / m;
    const S = (x * y + d * b) / m;
    const k = (-x * d + y * b) / m;
  ...
  function zu(n) {
    ...
    const i = r[0];
    const u = r[1];
    const o = [i, i, i, (r = n[1])[0]];
    const a = [u, u, u, r[1]];
    const l = [i, ",", u, "L", Ru(Pl, o), ",", Ru(Pl, a)];
  ...
  function Tu(n, t) {
    ...
    if (e)
      for (
        let r, i, u = n[0][0], o = n[0][1], a = n[e][0] - u, l = n[e][1] - o, c = -1;
        ++c <= e;
  ...
  function Hu(n) {
    for (let t, e, r, i = -1, u = n.length; ++i < u; )
      (t = n[i]),
        (e = t[0]),
        (r = t[1] - Io),
        (t[0] = e * Math.cos(r)),
  ...
  function Zu(n) {
    return function(...args) {
      const t = n.apply(this, args), e = t[0], r = t[1] - Io;
  ...
  function ro(n, t, e) {
    ...
    function i(n, e) {
      const r = n[1] - n[0], i = r / e, u = ao.bisect(Kl, i);
      return u == Kl.length
        ? [
            t.year,
            Ki(
    ...
    (r.nice = (n, t) => {
      ...
      const u = r.domain(), o = Yi(u), a = null == n ? i(o, 10) : "number" == typeof n && i(o, n);
  ...
  if (
    ...
    try {
      ...
      const po = this.Element.prototype, go = po.setAttribute, vo = po.setAttributeNS, yo = this.CSSStyleDeclaration.prototype, mo = yo.setProperty;
  ...
  (ao.ascending = e),
    ...
    (ao.quantile = (n, t) => {
      const e = (n.length - 1) * t + 1, r = Math.floor(e), i = +n[r - 1], u = e - r;
    ...
    (ao.deviation = function(...args) {
      const n = ao.variance.apply(this, args);
  ...
  (ao.bisectLeft = Mo.left),
    ...
    (ao.zip = function(...args) {
      return ao.transpose(args);
    }),
    (ao.keys = n => {
      const t = [];
    ...
    (ao.values = n => {
      const t = [];
      for (const e in n) t.push(n[e]);
      return t;
    }),
    (ao.entries = n => {
      const t = [];
      for (const e in n) t.push({ key: e, value: n[e] });
      return t;
    }),
    (ao.merge = n => {
  ...
  (ao.range = function (n, t, e) {
    ...
    (ao.map = function (n, t) {
      ...
      } else for (const o in n) e.set(o, n[o]);
      return e;
    });
  var bo = "__proto__",
    _o = "\x00";
  l(c, {
    ...
    values() {
      const n = [];
      for (const t in this._) n.push(this._[t]);
      return n;
    },
    entries() {
      const n = [];
      for (const t in this._) n.push({ key: s(t), value: this._[t] });
      return n;
    },
    size: v,
    empty: d,
    ...
    (ao.set = n => {
      const t = new y();
      if (n) for (let e = 0, r = n.length; r > e; ++e) t.add(n[e]);
      return t;
    }),
    l(y, {
      has: h,
    ...
    (ao.rebind = function (n, t) {
      for (let e, r = 1, i = arguments.length; ++r < i; )
        n[(e = arguments[r])] = M(n, t, t[e]);
      return n;
    });
  var wo = ["webkit", "ms", "moz", "Moz", "o", "O"];
  (ao.dispatch = function(...args) {
    for (var n = new _(), t = -1, e = args.length; ++t < e; )
      n[args[t]] = w(n);
    return n;
  }),
  ...
  var So = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,
    ...
    Ao = (n, t) => {
      const e = n.matches || n[x(n, "matchesSelector")];
      return (Ao = (n, t) => {
        return e.call(n, t);
      })(n, t);
    };
  ...
  (Co.select = function (n) {
    ...
    const u = [];
    n = A(n);
    for (let o = -1, a = this.length; ++o < a; ) {
      u.push((t = [])), (t.parentNode = (r = this[o]).parentNode);
      for (let l = -1, c = r.length; ++l < c; )
        (i = r[l])
    ...
    const r = [];
    n = C(n);
    for (let i = -1, u = this.length; ++i < u; )
      for (let o = this[i], a = -1, l = o.length; ++a < l; )
        (e = o[a]) &&
  ...
  (ao.ns = {
    ...
    (Co.append = function (n) {
      ...
      this.select(function(...args) {
        return this.appendChild(n.apply(this, args));
      })
    ;
    }),
    ...
    for (let u = 0, o = this.length; o > u; u++) {
      i.push((t = [])), (t.parentNode = (e = this[u]).parentNode);
      for (let a = 0, l = e.length; l > a; a++)
        (r = e[a]) && n.call(r, r.__data__, a, u) && t.push(r);
    }
    return E(i);
  }),
    (Co.order = function () {
      for (let n = -1, t = this.length; ++n < t; )
        for (let e, r = this[n], i = r.length - 1, u = r[i]; --i >= 0; )
          (e = r[i]) &&
    ...
    (Co.sort = function (n) {
      ...
      for (let t = -1, e = this.length; ++t < e; ) this[t].sort(n);
      return this.order();
    }),
    (Co.each = function (n) {
      return Y(this, (t, e, r) => {
  ...
  (ao.touch = function (n, t, e) {
    if ((arguments.length < 3 && ((e = t), (t = k().changedTouches)), t))
      for (let r, i = 0, u = t.length; u > i; ++i)
    ...
    (ao.behavior.drag = () => {
      ...
      function e(n, t, e, u, o) {
        return function(...args) {
          ...
          var c;
          const f = this;
          const s = ao.event.target.correspondingElement || ao.event.target;
          var h = f.parentNode;
          var p = r.of(f, args);
          var g = 0;
          var v = n();
          ...
          var M = t(h, v);
          i
            ? ((c = i.apply(f, args)), (c = [c.x - M[0], c.y - M[1]]))
            : (c = [0, 0]),
            p({ type: "dragstart" });
        };
      }
  ...
  (ao.interpolateZoom = (n, t) => {
    ...
    if (jo > h)
      ...
      const p = Math.sqrt(h), g = (c * c - o * o + $o * h) / (2 * o * Xo * p), v = (c * c - o * o - $o * h) / (2 * c * Xo * p), d = Math.log(Math.sqrt(g * g + 1) - g), y = Math.log(Math.sqrt(v * v + 1) - v);
      (r = (y - d) / Vo),
        (e = n => {
          const t = n * r, e = rn(d), a = (o / (Xo * p)) * (e * un(Vo * t + d) - en(d));
    ...
    function h(...args) {
      ...
      function t() {
        const t = ao.event.target;
        ao.select(t).on(x, r).on(b, a), _.push(t);
        for (let e = ao.event.changedTouches, i = 0, u = e.length; u > i; ++i)
          d[e[i].identifier] = null;
        const l = n(), c = Date.now();
        if (1 === l.length) {
          if (500 > c - M) {
            var f = l[0];
            o(
          ...
          const f = l[0], s = l[1], h = f[0] - s[0], p = f[1] - s[1];
          y = h * h + p * p;
        }
      }
      function r() {
        ...
        let e;
        let r;
        const o = ao.touches(g);
        Il.call(g);
        for (let a = 0, l = o.length; l > a; ++a, r = null)
          if (((e = o[a]), (r = d[e.identifier]))) {
            if (t) break;
            (n = e), (t = r);
          }
        if (r) {
          let f = (f = e[0] - n[0]) * f + (f = e[1] - n[1]) * f;
          const s = y && Math.sqrt(f / y);
      ...
      function a() {
        if (ao.event.touches.length) {
          for (
            let t = ao.event.changedTouches, e = 0, r = t.length;
            r > e;
            ++e
          )
            delete d[t[e].identifier];
          for (const i in d) return void n();
        }
    ...
    function g() {
      const n = ao.mouse(this), t = Math.log(k.k) / Math.LN2;
      o(
        this,
        n,
        e(n),
    ...
    var C = 250;
    var z = 0;
    var L = "mousedown.zoom";
    var q = "mousemove.zoom";
    var T = "mouseup.zoom";
    var R = "touchstart.zoom";
    var D = N(n, "zoomstart", "zoom", "zoomend");
    return Wo ||
      (Wo =
        "onwheel" in fo
          ? ((Bo = () => {
          ...
          : ((Bo = () => {
            ...
            "MozMousePixelScroll")),
    (n.event = n => {
      n.each(function(...args) {
        const n = D.of(this, args), t = k;
        Hl
          ? ao
              .select(this)
              .transition()
  ...
  var _a = {
      ...
      FeatureCollection(n, t) {
        for (let e = n.features, r = -1, i = e.length; ++r < i; )
          ht(e[r].geometry, t);
      },
    },
    wa = {
  ...
  (ao.geo.bounds = (() => {
        ...
        for (var e, r = 1, i = M[0], u = [i]; t > r; ++r)
          (e = M[r]),
            c(e[0], i) || c(e[1], i)
              ...
              : u.push((i = e));
        for (
          let o, e, g = -(1 / 0), t = u.length - 1, r = 0, i = u[t];
          t >= r;
          i = e, ++r
        )
          (e = u[r]),
    ...
    (ao.geo.centroid = n => {
      (Ea = Aa = Ca = za = La = qa = Ta = Ra = Da = Pa = Ua = 0),
        ao.geo.stream(n, ja);
      let t = Da, e = Pa, r = Ua, i = t * t + e * e + r * r;
      return jo > i &&
        ((t = qa),
        (e = Ta),
        (r = Ra),
  ...
  (ao.geo.clipExtent = () => {
    ...
    return (n.invert = n => {
      const t = u.scale(), e = u.translate(), r = (n[0] - e[0]) / t, i = (n[1] - e[1]) / t;
      return (
    ...
    (n.stream = n => {
      const t = u.stream(n), e = o.stream(n), r = a.stream(n);
      return {
        point(n, i) {
  ...
  ;
    ...
    (ao.geo.circle = () => {
    function n(...args) {
      const n = "function" == typeof r ? r.apply(this, args) : r, t = se(-n[0] * Yo, -n[1] * Yo, 0).invert, i = [];
  ...
  ;
    ...
    (ao.geo.greatArc = () => {
      ...
      var t,
        ...
        r = Me,
        i = xe;
      return (n.distance = function(...args) {
      ...
      (n.precision = function(...args) {
        return args.length ? n : 0;
      }),
      n
    ;
    }),
    (ao.geo.interpolate = (n, t) => {
  ...
  ((ao.geo.azimuthalEquidistant = () => {
    return oe(Qa);
  }).raw = Qa),
    ((ao.geo.conicConformal = () => {
      return Vt(Se);
    }).raw = Se),
    ((ao.geo.conicEquidistant = () => {
      return Vt(ke);
    }).raw = ke);
  const nl = we(n => {
    return 1 / n;
  ...
  ((ao.geo.stereographic = () => {
    ...
    ((ao.geo.transverseMercator = () => {
      const n = Ee(Ae), t = n.center, e = n.rotate;
      return (n.center = n => {
    ...
    (ao.geom.hull = function (n) {
      function t(n) {
        ...
        const c = Le(a), f = Le(l), s = f[0] === c[0], h = f[f.length - 1] === c[c.length - 1], p = [];
  ...
  (rl.area = function () {
    ...
    (rl.clip = function (n) {
      for (
        let t, e, r, i, u, o, a = De(n), l = -1, c = this.length - De(this), f = this[c - 1];
        ++l < c;
  ...
  (Ye.prototype.prepare = function () {
    ...
    (ao.geom.voronoi = n => {
    function t(n) {
      const t = new Array(n.length), r = a[0][0], i = a[0][1], u = a[1][0], o = a[1][1];
      return ar(e(n), a).cells.forEach((e, a) => {
        const l = e.edges,
              c = e.site,
              f = (t[a] = l.length
                ? l.map(n => {
    ...
    return n
      ...
      : ((t.links = n => {
        ...
        (t.triangles = n => {
          const t = [];
          return ar(e(n)).cells.forEach((e, r) => {
            for (
              let i, u, o = e.site, a = e.edges.sort(Ve), l = -1, c = a.length, f = a[c - 1].edge, s = f.l === o ? f.r : f.l;
              ++l < c;
    ...
    (ao.geom.quadtree = function (n, t, e, r, i) {
      function u(n) {
        ...
        function c(n, t, e, r, i, o, a, l) {
          const c = 0.5 * (i + a), f = 0.5 * (o + l), s = e >= c, h = r >= f, p = (h << 1) | s;
          (n.leaf = !1),
  ...
  (ao.ease = function (n) {
    const t = n.indexOf("-");
    let e = t >= 0 ? n.slice(0, t) : n;
    let r = t >= 0 ? n.slice(t + 1) : "in";
    return (e = vl.get(e) || gl),
    (r = dl.get(r) || m),
    br(r(e(...lo.call(arguments, 1))))
  ;
  }),
    ...
    (ao.transform = n => {
      const t = fo.createElementNS(ao.ns.prefix.svg, "g");
      return (ao.transform = n => {
        if (null != n) {
  ...
  ;
    ...
    function n(n) {
      return (t, e, r, i) => {
        if (t.point !== n) {
          const u = t.cx - n.x, o = t.cy - n.y, a = i - e, l = u * u + o * o;
          if (l > (a * a) / y) {
            if (v > l) {
              var c = t.charge / l;
              (n.px -= u * c), (n.py -= o * c);
    ...
    let a;
    var l = {};
    const c = ao.dispatch("start", "tick", "end");
    let f = [1, 1];
    let s = 0.9;
    let h = ml;
    let p = Ml;
  ...
  (ao.layout.hierarchy = () => {
    ...
    (ao.layout.pie = () => {
      function n(o) {
        ...
        let f = +("function" == typeof r ? r.apply(this, arguments) : r);
        const s = ("function" == typeof i ? i.apply(this, arguments) : i) - f;
  ...
  ao.layout.stack = () => {
    function n(a, l) {
      ...
      const s = e.call(n, f, l);
      (c = ao.permute(c, s)), (f = ao.permute(f, s));
      var h;
      let p;
      let g;
      let v;
      const d = r.call(n, f, l);
      const y = c[0].length;
      for (g = 0; y > g; ++g)
  ...
  ;
    ...
    (ao.layout.tree = () => {
      function n(n, i) {
        const f = o.call(this, n, i), s = f[0], h = t(s);
        if ((oi(h, e), (h.parent.m = -h.z), ui(h, r), c)) ui(s, u);
          ...
          const d = a(p, g) / 2 - p.x, y = l[0] / (g.x + a(g, p) / 2 + d), m = l[1] / (v.depth || 1);
          ui(s, n => {
      ...
      function t(n) {
        for (
          ...
          for (let i, u = t.children, o = 0, a = u.length; a > o; ++o)
            r.push(
              ((u[o] = i =
                {
                  _: u[o],
      ...
      function e(n) {
        const t = n.children, e = n.parent.children, r = n.i ? e[n.i - 1] : null;
        if (t.length) {
          Di(n);
          const u = (t[0].z + t[t.length - 1].z) / 2;
    ...
    (ao.layout.cluster = () => {
      function n(n, u) {
        ...
        const f = Fi(l), s = Hi(l), h = f.x - e(f, s) / 2, p = s.x + e(s, f) / 2;
        return oi(
          l,
          i
            ? n => {
    ...
    (ao.layout.treemap = () => {
    function n(n, t) {
      for (let e, r, i = -1, u = n.length; ++i < u; )
    ...
    var h = !1;
    var p = "squarify";
    var g = 0.5 * (1 + Math.sqrt(5));
    return (u.size = function (n) {
      return arguments.length ? ((c = n), u) : c;
    }),
    (u.padding = function (n) {
      function t(t) {
        const e = n.call(u, t, t.depth);
        return null == e
          ? Oi(t)
  ...
  ;
    ...
    (ao.random = {
      ...
      logNormal(...args) {
        const n = ao.random.normal.apply(ao, args);
        return () => {
          return Math.exp(n());
        };
      },
      bates(n) {
        const t = ao.random.irwinHall(n);
        return () => {
          return t() / n;
        };
      },
  ...
  (ao.scale.pow = () => {
    ...
    (ao.scale.category20b = () => {
      return ao.scale.ordinal().range(zl);
    }),
    (ao.scale.category20c = () => {
  ...
  (ao.scale.quantile = () => {
    ...
    (ao.svg.arc = () => {
      function n(...args) {
        let n = Math.max(0, +e.apply(this, args));
        let c = Math.max(0, +r.apply(this, args));
        const f = o.apply(this, args) - Io;
        const s = a.apply(this, args) - Io;
        const h = Math.abs(s - f);
        const p = f > s ? 0 : 1;
        ...
        const A = [];
        if (
          ((y = (+l.apply(this, args) || 0) / 2) &&
            ((d =
              u === ql ? Math.sqrt(n * n + c * c) : +u.apply(this, args)),
            p || (E *= -1),
        ...
        if (
          h > Uo &&
          (g = Math.min(Math.abs(c - n) / 2, +i.apply(this, args))) > 0.001
        ) {
          v = (c > n) ^ p ? 0 : 1;
          let T = g, R = g;
          if (Fo > h) {
          ...
          if (null != x) {
            const I = mu(null == S ? [_, w] : [S, k], [m, M], c, T, p), Y = mu([x, b], [_, w], c, T, p);
            g === T
              ? A.push(
                  "M",
                  I[0],
          ...
          if (null != S) {
            const Z = mu([m, M], [S, k], n, -R, p), V = mu([_, w], null == x ? [m, M] : [x, b], n, -R, p);
            g === R
              ? A.push(
                  "L",
                  V[0],
      ...
      (n.centroid = function(...args) {
        const n = (+e.apply(this, args) + +r.apply(this, args)) / 2,
              t =
                (+o.apply(this, args) + +a.apply(this, args)) / 2 - Io;
  ...
  (ao.svg.line.radial = () => {
    ...
    (ao.svg.chord = () => {
      function n(n, a) {
        const l = t(this, u, n, a), c = t(this, o, n, a);
        return (
          "M" +
          l.p0 +
      ...
      function t(n, t, e, r) {
        const i = t.call(n, e, r), u = a.call(n, i, r), o = l.call(n, i, r) - Io, f = c.call(n, i, r) - Io;
        return {
          r: u,
          a0: o,
          a1: f,
    ...
    (ao.svg.diagonal = () => {
      function n(n, i) {
        const u = t.call(this, n, i);
        const o = e.call(this, n, i);
        const a = (u.y + o.y) / 2;
        let l = [u, { x: u.x, y: a }, { x: o.x, y: a }, o];
        return (
    ...
    (ao.svg.diagonal.radial = () => {
    const n = ao.svg.diagonal();
    let t = Yu;
  ...
  var Ul = ao.map({
    ...
    diamond(n) {
      const t = Math.sqrt(n / (2 * Fl)), e = t * Fl;
      return "M0," + -t + "L" + e + ",0 0," + t + " " + -e + ",0Z";
    },
    square(n) {
      const t = Math.sqrt(n) / 2;
      return (
        "M" +
        -t +
        "," +
    ...
    "triangle-down": function (n) {
      const t = Math.sqrt(n / jl), e = (t * jl) / 2;
  ...
  (Co.transition = function (n) {
    for (
      ...
      u.push((t = []));
      for (let c = this[a], f = -1, s = c.length; ++f < s; )
  ...
  (Yl.call = Co.call),
    ...
    for (let u = 0, o = this.length; o > u; u++) {
      i.push((t = []));
      for (let e = this[u], a = 0, l = e.length; l > a; a++)
        (r = e[a]) && n.call(r, r.__data__, a, u) && t.push(r);
    }
    return Wu(i, this.namespace, this.id);
  }),
    (Yl.tween = function (n, t) {
      const e = this.id, r = this.namespace;
      return arguments.length < 2
      ...
      function u(n) {
        return null == n
          ...
          : ((n += ""),
            function () {
              let t;
              const e = this.getAttributeNS(a.space, a.local);
              return (
                e !== n &&
                ((t = o(e, n)),
                function (n) {
    ...
    (Yl.attrTween = function (n, t) {
      function e(n, e) {
        const r = t.call(this, n, e, this.getAttribute(i));
        return (
          r &&
          function (n) {
      ...
      function r(n, e) {
        const r = t.call(this, n, e, this.getAttributeNS(i.space, i.local));
        return (
          r &&
          function (n) {
      ...
      function u(e) {
        return null == e
          ...
          : ((e += ""),
            function () {
              let i;
              const u = t(this).getComputedStyle(this, null).getPropertyValue(n);
              return (
                u !== e &&
                ((i = Mr(u, e)),
                function (t) {
    ...
    (Yl.ease = function (n) {
      const t = this.id, e = this.namespace;
      return arguments.length < 1
        ? this.node()[e][t].ease
        : ("function" != typeof n && (n = ao.ease(...arguments)),
          Y(this, r => {
            r[e][t].ease = n;
          }));
    }),
    ...
    (Yl.transition = function () {
      for (
        ...
        a.push((n = []));
        for (let t = this[l], f = 0, s = t.length; s > f; f++)
          (e = t[f]) &&
            ((r = e[o][i]),
            Qu(e, f, o, u, {
              time: r.time,
    ...
    (ao.svg.axis = () => {
      function n(n) {
        n.each(function () {
          let n;
          const c = ao.select(this);
          let f = this.__chart__ || e;
          let s = (this.__chart__ = e.copy());
          const h = null == l ? (s.ticks ? s.ticks(...a) : s.domain()) : l;
          const p = null == t ? (s.tickFormat ? s.tickFormat(...a) : m) : t;
          const g = c.selectAll(".tick").data(h, s);
          ...
          const d = ao.transition(g.exit()).style("opacity", Uo).remove();
          const y = ao.transition(g.order()).style("opacity", 1);
          const M = Math.max(i, 0) + o;
          const x = Zi(s);
          const b = c.selectAll(".domain").data([0]);
          ...
          let k;
          let N;
          const E = v.select("line");
          const A = y.select("line");
          const C = g.select("text").text(p);
          const z = v.select("text");
          const L = y.select("text");
          const q = "top" === r || "left" === r ? -1 : 1;
          if (
            ("bottom" === r || "top" === r
              ? ((n = no),
                (w = "x"),
      ...
      (n.ticks = function(...args) {
        return args.length ? ((a = co(args)), n) : a;
      }),
  ...
  ao.svg.brush = () => {
      ...
      t.each(function () {
        ...
        o
          ...
          t
            ...
            .attr("class", "extent")
            .style("cursor", "move");
        const a = t.selectAll(".resize").data(v, m);
        a.exit().remove(),
          a
            .enter()
            .append("g")
        ...
        let l;
        const s = ao.transition(t);
        const h = ao.transition(o);
    ...
    function u(...args) {
      ...
      var x;
      var b = this;
      const _ = ao.select(ao.event.target);
      var w = l.of(b, args);
      var k = ao.select(b);
      const N = _.datum();
      var E = !/^(n|s)$/.test(N) && c;
      var A = !/^(e|w)$/.test(N) && f;
      var C = _.classed("extent");
      var z = W(b);
      var L = ao.mouse(b);
      var q = ao.select(t(b)).on("keydown.brush", u).on("keyup.brush", v);
      if (
    ...
    return (n.event = n => {
      n.each(function(...args) {
        const n = l.of(this, args), t = { x: s, y: h, i: o, j: a }, e = this.__chart__ || t;
        (this.__chart__ = t),
          Hl
            ? ao
                .select(this)
  ...
  const Wl = (ga.format = xa.timeFormat);
  const Jl = Wl.utc;
  const Gl = Jl("%Y-%m-%dT%H:%M:%S.%LZ");
  (Wl.iso =
    ...
    (ga.hour = On(
      n => {
        const t = n.getTimezoneOffset() / 60;

!(function () {
  ...
  function Zu(n) {
    return function () {
      const t = n.apply(this, arguments), e = t[0], r = t[1] - Io;
  ...
  (ao.ascending = e),
    ...
    (ao.deviation = function () {
      const n = ao.variance.apply(this, arguments);
  ...
  (ao.interpolateZoom = (n, t) => {
    ...
    (n.event = n => {
      n.each(function () {
        const n = D.of(this, arguments), t = k;
        Hl
          ? ao
              .select(this)
              .transition()
  ...
  ;
    ...
    (ao.geo.circle = () => {
    function n() {
      const n = "function" == typeof r ? r.apply(this, arguments) : r, t = se(-n[0] * Yo, -n[1] * Yo, 0).invert, i = [];
  ...
  ;
    ...
    (ao.random = {
      ...
      logNormal() {
        const n = ao.random.normal.apply(ao, arguments);
        return () => {
          return Math.exp(n());
        };
      },
  ...
  (ao.scale.quantile = () => {
    ...
    (ao.svg.arc = () => {
      function n() {
        let n = Math.max(0, +e.apply(this, arguments));
        let c = Math.max(0, +r.apply(this, arguments));
        const f = o.apply(this, arguments) - Io;
        const s = a.apply(this, arguments) - Io;
      ...
      (n.centroid = function () {
        const n = (+e.apply(this, arguments) + +r.apply(this, arguments)) / 2,
              t =
    ...
    (ao.svg.axis = () => {
      function n(n) {
        n.each(function () {
          ...
          const h = null == l ? (s.ticks ? s.ticks.apply(s, a) : s.domain()) : l;
          const p = null == t ? (s.tickFormat ? s.tickFormat.apply(s, a) : m) : t;
  ...
  ao.svg.brush = () => {
    ...
    return (n.event = n => {
      n.each(function () {
        const n = l.of(this, arguments), t = { x: s, y: h, i: o, j: a }, e = this.__chart__ || t;
        (this.__chart__ = t),
          Hl
            ? ao
                .select(this)

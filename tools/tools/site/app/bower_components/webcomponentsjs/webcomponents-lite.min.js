...
!(() => {
  ...
  const e = "webcomponents-lite.js", t = document.querySelector('script[src*="' + e + '"]'), n = {};
  if (!n.noOpts) {
    if (
      (location.search
        .slice(1)
      ...
      for (let o, r = 0; (o = t.attributes[r]); r++)
  ...
  if (!e.JsMutationObserver) {
    ...
    (p.prototype = {
      enqueue(e) {
        const n = this.observer.records_, o = n.length;
        if (n.length > 0) {
          const r = n[o - 1], i = f(r, e);
        ...
        switch ((e.stopImmediatePropagation(), e.type)) {
          ...
          case "DOMNodeInserted":
            ...
            "DOMNodeInserted" === e.type
              ? ((s = [h]), (c = []))
              : ((s = []), (c = [h]));
            const f = h.previousSibling, p = h.nextSibling, r = d("childList", e.target.parentNode);
            (r.addedNodes = s),
              (r.removedNodes = c),
              (r.previousSibling = f),
              (r.nextSibling = p),
  ...
  const n = "undefined" == typeof HTMLTemplateElement;
  /Trident/.test(navigator.userAgent) &&
    !(() => {
      const e = document.importNode;
      document.importNode = function () {
        const t = e.apply(document, arguments);
  ...
  var o = (() => {
      if (!n) {
        const e = document.createElement("template"), t = document.createElement("template");
  ...
  const i = () => {};
  if (n) {
    const a = document.implementation.createHTMLDocument("template");
    let s = !0;
    ...
    d.insertBefore(c, d.firstElementChild),
      ...
      (i.decorate = e => {
        if (!e.content) {
          ...
          for (let n; (n = e.firstChild); ) e.content.appendChild(n);
          if (
      ...
      (i.bootstrap = e => {
        for (
          let t, n = e.querySelectorAll(r), o = 0, a = n.length;
          o < a && (t = n[o]);
          o++
        )
          i.decorate(t);
    ...
    document.createElement = function () {
      "use strict";
      const e = l.apply(document, arguments);
      return "template" === e.localName && i.decorate(e), e;
    };
    var u = /[&\u00A0<>]/g;
  }
  if (n || o) {
    const h = Node.prototype.cloneNode;
    (i.cloneNode = function (e, t) {
      ...
      (i.fixClonedDom = function (e, t) {
        if (t.querySelectorAll)
          for (
            let n, o, i = t.querySelectorAll(r), a = e.querySelectorAll(r), s = 0, c = a.length;
            s < c;
            s++
          )
            (o = i[s]),
  ...
  function s(e) {
    for (let t, n = 0, o = e.length; n < o && (t = e[n]); n++) c(t) && d(t);
  }
  function c(e) {
  ...
  const l = "import";
  var u = Boolean(l in document.createElement("link"));
  const h = Boolean(window.ShadowDOMPolyfill);
  ...
  const v = /Trident/.test(navigator.userAgent);
  var w = v ? "complete" : "interactive";
  var _ = "readystatechange";
  u &&
    (new MutationObserver(e => {
      for (let t, n = 0, o = e.length; n < o && (t = e[n]); n++)
        t.addedNodes && s(t.addedNodes);
    }).observe(document.head, { childList: !0 }), (() => {
    if ("loading" === document.readyState)
      for (
        let e, t = document.querySelectorAll("link[rel=import]"), n = 0, o = t.length;
        n < o && (e = t[n]);
        n++
      )
        d(e);
    ...
    t(e => {
      ...
      const t = p.createEvent("CustomEvent");
  ...
  const t = /(url\()([^)]*)(\))/g,
        ...
        o = {
          resolveUrlsInStyle(e, t) {
            const n = e.ownerDocument, o = n.createElement("a");
            return (
              (e.textContent = this.resolveUrlsInCssText(e.textContent, t, o)), e
            );
          },
          resolveUrlsInCssText(e, o, r) {
            let i = this.replaceUrls(e, r, o, t);
            return (i = this.replaceUrls(i, r, o, n));
          },
          replaceUrls(e, t, n, o) {
            return e.replace(o, (e, o, r, i) => {
              let a = r.replace(/["']/g, "");
              return (
  ...
  function r(e) {
    ...
    const n = e.ownerDocument.baseURI, o = t.__importedScripts ? "-" + t.__importedScripts : "";
  ...
  const h = {
    ...
    nextToParseInDoc(e, n) {
      if (e && this._mayParse.indexOf(e) < 0) {
        ...
        for (
          let o, r = e.querySelectorAll(this.parseSelectorsForNode(e)), i = 0, a = r.length;
          i < a && (o = r[i]);
          i++
        )
          if (!this.isParsed(o))
  ...
  const f = new d(h.loaded.bind(h), h.loadedAll.bind(h));
  ...
  const t = e.parser,
        ...
        o = {
          added(e) {
            for (let o, r, i, a, s = 0, c = e.length; s < c && (a = e[s]); s++)
  ...
  function i(e, t, n) {
    if (((e = window.wrap(e)), !(n.indexOf(e) >= 0))) {
      n.push(e);
      for (
        let o, r = e.querySelectorAll("link[rel=" + a + "]"), s = 0, c = r.length;
        s < c && (o = r[s]);
        s++
      )
  ...
  function i() {
    E = !1;
    for (let e, t = L, n = 0, o = t.length; n < o && (e = t[n]); n++) e();
    L = [];
  }
  function a(e) {
    y
  ...
  function m(e) {
    if (!e.__observer) {
      const t = new MutationObserver(f.bind(this, e));
  ...
  var E = !1;
  var L = [];
  var N = Array.prototype.forEach.call.bind(Array.prototype.forEach);
  ...
  function r(e, t, n) {
    for (let o = {}, r = t; r !== n && r !== HTMLElement.prototype; ) {
      for (let i, a = Object.getOwnPropertyNames(r), s = 0; (i = a[s]); s++)
        o[i] ||
  ...
  function r(e) {
    for (let t = 0; t < y.length; t++) if (e === y[t]) return !0;
  }
  function i(e) {
    const t = d(e);
  ...
  var w = e.upgradeAll;
  var _ = e.upgradeWithDefinition;
  var g = e.implementPrototype;
  const b = e.useNative;
  ...
  const n = e.useNative, o = e.initializeModules;
  e.isIE;
  if (n) {
    const r = () => {};
    (e.watchShadow = r),

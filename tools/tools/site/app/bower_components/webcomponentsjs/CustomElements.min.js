...
"undefined" == typeof WeakMap &&
        ...
        switch ((e.stopImmediatePropagation(), e.type)) {
          ...
          case "DOMNodeInserted":
            ...
            "DOMNodeInserted" === e.type
              ? ((d = [f]), (s = []))
              : ((d = []), (s = [f]));
            const p = f.previousSibling, w = f.nextSibling, r = u("childList", e.target.parentNode);
            (r.addedNodes = d),
              (r.removedNodes = s),
              (r.previousSibling = p),
              (r.nextSibling = w),
...
})(window.WebComponents), window.CustomElements = window.CustomElements || { flags: {} }, (e => {
  const t = e.flags,
        n = [],
        o = e => {
          n.push(e);
  ...
  function i(e, t, n) {
    if (((e = window.wrap(e)), !(n.indexOf(e) >= 0))) {
      n.push(e);
      for (
        let o, r = e.querySelectorAll("link[rel=" + a + "]"), d = 0, s = r.length;
        d < s && (o = r[d]);
        d++
      )

...
"undefined" == typeof WeakMap &&
        ...
        switch ((e.stopImmediatePropagation(), e.type)) {
          ...
          case "DOMNodeInserted":
            ...
            "DOMNodeInserted" === e.type
              ? ((s = [h]), (d = []))
              : ((s = []), (d = [h]));
            const m = h.previousSibling, p = h.nextSibling, o = c("childList", e.target.parentNode);
            (o.addedNodes = s),
              (o.removedNodes = d),
              (o.previousSibling = m),
              (o.nextSibling = p),
  ...
  function s(e) {
    for (let t, n = 0, r = e.length; n < r && (t = e[n]); n++) d(t) && c(t);
  }
  function d(e) {
  ...
  const u = "import";
  var l = Boolean(u in document.createElement("link"));
  ...
  (r.prototype = {
    ...
    receive(e, t, n, r, o) {
      this.cache[e] = r;
      for (
        let i, a = this.pending[e], s = 0, d = a.length;
        s < d && (i = a[s]);
        s++
      )
    ...
    trackElement(e, t) {
      ...
      if (
        ...
        if (e.textContent.indexOf("@import") == -1) o = !0;
          ...
          o = !0;
          for (
            let i, a = e.sheet.cssRules, s = a ? a.length : 0, d = 0;
            d < s && (i = a[d]);
            d++
          )
  ...
  const m = new c(h.loaded.bind(h), h.loadedAll.bind(h));
  ...
  const t = e.parser,
        ...
        r = {
          added(e) {
            for (let r, o, i, a, s = 0, d = e.length; s < d && (a = e[s]); s++)

...
"undefined" == typeof WeakMap &&
  ...
  if (!e.JsMutationObserver) {
    ...
    (f.prototype = {
      enqueue(e) {
        const r = this.observer.records_, i = r.length;
        if (r.length > 0) {
          const n = r[i - 1], a = l(n, e);
        ...
        switch ((e.stopImmediatePropagation(), e.type)) {
          ...
          case "DOMNodeInserted":
            ...
            "DOMNodeInserted" === e.type
              ? ((o = [v]), (d = []))
              : ((o = []), (d = [v]));
            const l = v.previousSibling, f = v.nextSibling, n = u("childList", e.target.parentNode);
            (n.addedNodes = o),
              (n.removedNodes = d),
              (n.previousSibling = l),
              (n.nextSibling = f),

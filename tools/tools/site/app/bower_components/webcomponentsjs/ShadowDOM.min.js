...
"undefined" == typeof WeakMap &&
    ...
    for (s.push(c); c; ) {
      ...
      if (u && u.length > 0) {
        for (let l = 0; l < u.length; l++) {
          const d = u[l];
          if (i(d)) {
            const f = n(d), h = f.olderShadowRoot;
            h && s.push(h);
          }
          s.push(d);
        }
  ...
  function T(e, t, n, r) {
    ...
    const o = q(document.createEvent(t)), i = me[t], a = [n];
  ...
  (S.prototype = Object.create(M.prototype)),
    C(S.prototype, {
      ...
      removeChild(e) {
        ...
        const i = W(e), a = e.nextSibling, s = e.previousSibling;
        if (this.invalidateShadowRenderer()) {
          const c = this.firstChild, u = this.lastChild, l = i.parentNode;
          l && J(l, i),
  ...
  const P = document.createTreeWalker, W = e.wrappers.TreeWalker;
  if (

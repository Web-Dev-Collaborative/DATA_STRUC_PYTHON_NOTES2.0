...
!((a, b) => {
  ...
  !((a, b) => {
    ...
    !((a, b, c) => {
      ...
      var e = a.consumeRepeated.bind(void 0, d, /^/);
      const f = a.mergeNestedRepeated.bind(void 0, a.mergeDimensions, " ");
      var g = a.mergeNestedRepeated.bind(void 0, f, ",");

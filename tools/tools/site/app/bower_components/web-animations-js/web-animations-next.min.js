...
!((a, b) => {
  ...
  !((a, b) => {
    ...
    function f(b, c, e) {
      const f = new d();
      return c && ((f.fill = "both"), (f.duration = "auto")),
    ...
    function k(a) {
      ...
      const b = C.animationTimingFunction;
      if ("" == b && e())
    ...
    function u(a, b, c) {
      const d = o(a, b, c), e = p(a, c.fill, b, d, c.delay);
      if (null === e) return null;
      const f = q(c.duration, d, c.iterations, e, c.iterationStart), g = r(f, c.iterationStart, d, c.iterations, e, c.duration), h = s(d, c.iterations, g, f), i = t(c.direction, h, g);
    ...
    var F = /steps\(\s*(\d+)\s*,\s*(start|middle|end)\s*\)/;
    var G = 0;
    var H = 1;
    var I = 2;
    var J = 3;
    ...
    function f(a) {
      ...
      for (const c in a)
        if (!(c in ["easing", "offset", "composite"])) {
          let d = a[c];
          Array.isArray(d) || (d = [d]);
          for (let e, f = d.length, g = 0; g < f; g++)
            (e = {}),
              "offset" in a
                ? (e.offset = a.offset)
                : 1 == f
    ...
    function g(b) {
      function c() {
        ...
        for (let b = 0, c = d[0].offset, e = 1; e < a; e++) {
          const f = d[e].offset;
          if (null != f) {
            for (let g = 1; g < e - b; g++)
    ...
    const j = { thin: "1px", medium: "3px", thick: "5px" };
    ...
    const b = {};
    (a.isDeprecated = (a, c, d, e) => {
      const f = e ? "are" : "is", g = new Date(), h = new Date(c);
      return (
    ...
    if (document.documentElement.animate) {
      const a = document.documentElement.animate([], 0);
      var b = !0;
      if (
        (a &&
          ((b = !1),
    ...
    !((a, b, c) => {
      ...
      function e(c) {
        const d = [];
        for (const e in c)
          for (let f = c[e], g = 0; g < f.length - 1; g++) {
            let h = g;
            let i = g + 1;
            const j = f[h].offset;
            const k = f[i].offset;
      ...
      b.convertEffectInput = c => {
        const f = a.normalizeKeyframes(c), g = d(f), h = e(g);
        return (a, c) => {
          if (null != c)
            h.filter(a => {
              return c >= a.applyFrom && c < a.applyTo;
            }).forEach(d => {
              const e = c - d.startOffset, f = d.endOffset - d.startOffset, g = 0 == f ? 0 : d.easingFunction(e / f);
      ...
      function g(c, e, f) {
        ...
        for (let j = e == f ? [] : h[g], k = 0; j && k < j.length; k++) {
          const l = j[k][0](e), m = j[k][0](f);
          if (void 0 !== l && void 0 !== m) {
            const n = j[k][1](l, m);
            if (n) {
              const o = b.Interpolation.apply(null, n);
              return a => {
      ...
      function d(b) {
        const c = a.calculateActiveDuration(b),
              d = d => {
                return a.calculateIterationProgress(c, d, b);
              };
        return (d._totalDuration = b.delay + c + b.endDelay), d;
      }
      (b.KeyframeEffect = (c, e, f, g) => {
        let h;
        const i = d(a.normalizeTimingInput(f));
        const j = b.convertEffectInput(e);
      ...
      function d(a) {
        ...
        for (let b = 0; b < this._style.length; b++) {
          const c = this._style[b];
      ...
      const f = { cssText: 1, length: 1, parentRule: 1 },
            g = {
      ...
      for (const i in g)
        d.prototype[i] = ((a, b) => {
          return function () {
            const c = this._surrogateStyle[a].apply(
      ...
      for (const j in document.documentElement.style)
        j in f ||
          j in g ||
          !(a => {
            c(d.prototype, a, {
      ...
      function d(b, d, e) {
        ...
        if (1 === f) g = b;
          ...
          for (
            let h = Math.acos(f), i = (1 * Math.sin(e * h)) / Math.sqrt(1 - f * f), j = 0;
            j < 4;
            j++
          )
      ...
      const e = (() => {
        function a(a, b) {
          for (
            ...
            for (let e = 0; e < 4; e++)
              for (let f = 0; f < 4; f++) c[d][e] += b[d][f] * a[f][e];
          return c;
        }
        function b(a) {
          return (
      ...
      (b.Animation = function (b) {
        ...
        (b.Animation.prototype = {
          ...
          removeEventListener(a, b) {
            if ("finish" == a) {
              const c = this._finishHandlers.indexOf(b);
          ...
          _fireEvents(a) {
            if (this._isFinished) {
              if (!this._finishedFlag) {
                const b = new d(this, this._currentTime, a),
          ...
          _markTarget() {
            const a = this._targetAnimations();
            a.indexOf(this) === -1 && a.push(this);
          },
          _unmarkTarget() {
            const a = this._targetAnimations(), b = a.indexOf(this);
            b !== -1 && a.splice(b, 1);
          },
        });
    })(c, d, f), ((a, b, c) => {
      ...
      function h(a, c, d) {
        ...
        return d.forEach(b => {
          b._tick(a, c),
            ...
            b._needsTick && (m = !0);
          const d = b._inEffect || b._needsTick;
      ...
      var l = void 0,
        ...
        n = !1;
      (b.restart = () => {
        return m || ((m = !0), requestAnimationFrame(() => {}), (n = !0)),
        n
      ;
      }),
        (b.applyDirtiedAnimation = a => {
          if (!p) {
            a._markTarget();
            const c = a._targetAnimations();
            c.sort(e);
            const d = h(b.timeline.currentTime, !1, c.slice())[1];
            d.forEach(a => {
              const b = q._animations.indexOf(a);
      ...
      function e(a) {
        const b = a.rad || 0, c = a.deg || 0, d = a.grad || 0, e = a.turn || 0, f = (c / 360 + d / 400 + e) * (2 * Math.PI) + b;
        return f;
      }
      function f(a) {
        switch (a.t) {
          ...
          case "rotate3d":
            ...
            const i = Math.sin(b / 2), j = i * Math.cos(b / 2), k = i * i;
            return [
              1 - 2 * (d * d + f * f) * k,
              2 * (c * d * k + f * j),
              2 * (c * f * k - d * j),
      ...
      function i(b, c) {
        for (var d = [], e = 0; e < b.length; e++) {
          const f = a.consumeTrimmed(b[e], c);
          if (!f || "" == f[0]) return;
      ...
      function j(a, b, c, d, e) {
        for (
          ...
          const l = b(d[k % d.length], e[k % e.length]);
          if (!l) return;
      ...
      function b(b) {
        ...
        const e = a.consumeRepeated(c, /^/, b);
        if (e && e[0].length) return [d, e[1]];
      }
      function c(c) {
        const d = a.consumeRepeated(b, /^,/, c);
        if (d && "" == d[1]) return d[0];
      }
      function d(b, c) {
        for (
        ...
        if (b.inset == c.inset && !!b.color == !!c.color) {
          for (
            ...
            const i = a.mergeDimensions(b.lengths[h], c.lengths[h], 2 == h);
            f[0].push(i[0]), g[0].push(i[1]), e.push(i[2]);
          }
          if (b.color && c.color) {
            const j = a.mergeColors(b.color, c.color);
      ...
      function e(b, c, d, e) {
        ...
        for (var g = [], h = [], i = 0; i < d.length || i < e.length; i++) {
          const j = d[i] || f(e[i].inset), k = e[i] || f(d[i].inset);
          g.push(j), h.push(k);
        }
        return a.mergeNestedRepeated(b, c, g, h);
      }
      const f = e.bind(null, d, ", ");
      ...
      function c(a) {
        ...
        if (((f.fillStyle = "#fff"), (f.fillStyle = a), b == f.fillStyle)) {
          f.fillRect(0, 0, 1, 1);
          const c = f.getImageData(0, 0, 1, 1).data;
          f.clearRect(0, 0, 1, 1);
          const d = c[3] / 255;
      ...
      function d(b, c) {
        return [
          ...
          b => {
            ...
            if (b[3])
              for (let d = 0; d < 3; d++) b[d] = Math.round(c(b[d] / b[3]));
            return (
      ...
      const f = "px|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc", g = c.bind(null, new RegExp(f, "g")), h = c.bind(null, new RegExp(f + "|%", "g")), i = c.bind(null, /deg|rad|grad|turn/g);
      (a.parseLength = g),
        (a.parseLengthOrPercent = h),
        (a.consumeLengthOrPercent = a.consumeParenthesised.bind(null, h)),
        (a.parseAngle = i),
        (a.mergeDimensions = e);
      const j = a.consumeParenthesised.bind(null, g), k = a.consumeRepeated.bind(void 0, j, /^/), l = a.consumeRepeated.bind(void 0, k, /^,/);
      ...
      const g = a.mergeWrappedNestedRepeated.bind(null, f, e, ", ");
      (a.parseBox = d),
        (a.mergeBoxes = g),
        ...
        return null == d[0] || null == e[0]
          ...
          : (d[0].push(0),
            ...
            [
              ...
              e,
              b => {
                const c = a.quat(d[0][3], e[0][3], b[5]), g = a.composeMatrix(b[0], b[1], b[2], c, b[4]), h = g.map(f).join(",");
                return h;
              },
            ]);
      }
      ...
      function j(b, c) {
        const d = a.makeMatrixDecomposition && !0;
        let e = !1;
        if (!b.length || !c.length) {
          ...
          for (var f = 0; f < b.length; f++) {
            var j = b[f].t;
            const k = b[f].d;
            const l = "scale" == j.substr(0, 5) ? 1 : 0;
            c.push({
              t: j,
              d: k.map(a => {
                if ("number" == typeof a) return l;
                const b = {};
                for (const c in a) b[c] = l;
                return b;
              }),
            });
          }
      ...
      class b {
        constructor(b) {
          const c = a.consumeToken(/^circle/, b);
          if (c && c[0])
          ...
          const f = a.consumeToken(/^ellipse/, b);
          if (f && f[0])
          ...
          const g = a.consumeToken(/^polygon/, b);
          return g && g[0]
            ? ["polygon"].concat(
                a.consumeList(
                  [
        ...
        static restartWebAnimationsNextTick() {
          f || ((f = !0), requestAnimationFrame(d));
        }

        static awaitStartTime(a) {
          null === a.startTime &&
            a._isGroup &&
            (0 == i.length && requestAnimationFrame(e), i.push(a));
        }

        static bindAnimationForCustomEffect(b) {
          let c;
          const e = b.effect.target;
          const g = "function" == typeof b.effect.getFrames();
          c = g ? b.effect.getFrames() : b.effect._onsample;
          let h = b.effect.timing, i = null;
          h = a.normalizeTimingInput(h);
          const j = () => {
            let d = j._animation ? j._animation.currentTime : null;
            null !== d &&
    ...
    if (void 0 === document.createElement("div").animate([]).oncancel) {
      ...
      window.Element.prototype.animate = function (d, e) {
        const f = c.call(this, d, e);
        (f._cancelHandlers = []), (f.oncancel = null);
        const g = f.cancel;
        f.cancel = function () {
          g.call(this);
          const c = new b(this, null, a()),
    ...
    let d = !1;
    try {
      const e = getComputedStyle(b).getPropertyValue("opacity"), f = "0" == e ? "1" : "0";
    ...
    if (!d) {
      const g = window.Element.prototype.animate;
      window.Element.prototype.animate = function (b, c) {
        return (
          window.Symbol &&
            Symbol.iterator &&
    ...
    (window.requestAnimationFrame = a => {
      ...
      (b.AnimationTimeline.prototype = {
        ...
        _play(a) {
          const c = new b.Animation(a, this);
          return (
    ...
    var f = !1;
    const g = new b.AnimationTimeline();
    b.timeline = g;
    try {
    ...
    (b.animationsWithPromises = []),
      ...
      (b.Animation.prototype = {
        _updatePromises() {
          const a = this._oldPlayState, b = this.playState;
          return (
            this._readyPromise &&
              b !== a &&
              ("idle" == b
        ...
        _updateChildren() {
          if (this.effect && "idle" != this.playState) {
            let a = this.effect._timing.delay;
        ...
        _setExternalAnimation(a) {
          if (this.effect && this._isGroup)
            for (let b = 0; b < this.effect.children.length; b++)
        ...
        get finished() {
          return window.Promise
            ? (this._finishedPromise ||
                (b.animationsWithPromises.indexOf(this) == -1 &&
        ...
        set oncancel(a) {
          "function" == typeof a
            ? (this._animation.oncancel = b => {
                (b.target = this), a.call(this, b);
              })
            : (this._animation.oncancel = a);
        },
        get currentTime() {
          this._updatePromises();
          const a = this._animation.currentTime;
        ...
        play() {
          this._updatePromises(),
            ...
            this._timeline._animations.indexOf(this) == -1 &&
    ...
    const f = a => {
      if (
        ...
        for (let b = 0; b < a.children.length; b++) f(a.children[b]);
    };
    (b.removeMulti = a => {
      for (var b = [], c = 0; c < a.length; c++) {
        const d = a[c];
        d._parent
          ? (b.indexOf(d._parent) == -1 && b.push(d._parent),
    ...
    const g = Element.prototype.animate;
    ...
    (b.newUnderlyingAnimationForKeyframeEffect = a => {
      if (a) {
        var b = a.target || h,
          c = a._keyframes;
        "function" == typeof c && (c = []);
      ...
      (b.bindAnimationForKeyframeEffect = a => {
        a.effect &&
    ...
    function e(a) {
      ...
      (g = []),
        ...
        (b = b.filter(a => {
          a();
          const b = a._animation ? a._animation.playState : "idle";
          return (
    ...
    (window.SequenceEffect = function () {
      ...
      (e.prototype = {
        ...
        _reparent(a) {
          b.removeMulti(a);
          for (let c = 0; c < a.length; c++) a[c]._parent = this;
        },
        _putChild(a, b) {
          for (
            var c = b
      ...
      Object.defineProperty(
        ...
        "activeDuration",
        {
          get() {
            let a = 0;
            return this.children.forEach(b => {
              a += d(b);
            }),
            Math.max(a, 0)
          ;
      ...
      (b.newUnderlyingAnimationForGroup = c => {
      let d;
      let e = null;
      ...
      const g = new KeyframeEffect(null, [], c._timing, c._id);
      return (g.onsample = f), (d = b.timeline._play(g));
    }),
      (b.bindAnimationForGroup = a => {

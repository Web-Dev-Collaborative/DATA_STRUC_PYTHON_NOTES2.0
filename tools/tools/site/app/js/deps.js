...
goog.addDependency(
  ...
  ["claat.ui.cards.Filter", "claat.ui.cards.Order", "claat.ui.cards.Sorter"],
  [],
  false
);
goog.addDependency(
  "../../../../app/js/claat/ui/cards/cardsorter_test.js",
  ["claat.ui.cards.SorterTest"],
  [
    "claat.ui.cards.Filter",
    "claat.ui.cards.Order",
    "claat.ui.cards.Sorter",
    "goog.dom",
    "goog.testing.jsunit",
  ],
  false
...
goog.addDependency(
  "../../../../app/js/claat/uri/params.js",
  ["claat.uri.params"],
  [],
  false
);
goog.addDependency(
  "../../../../app/js/claat/uri/params_test.js",
  ["claat.uri.paramsTest"],
  ["claat.uri.params", "goog.testing.jsunit"],
  false
);
goog.addDependency(
...
goog.addDependency("array/array.js", ["goog.array"], ["goog.asserts"], false);
goog.addDependency(
  "array/array_test.js",
  ["goog.arrayTest"],
  [
...
goog.addDependency(
  "async/run.js",
  ["goog.async.run"],
  ["goog.async.WorkQueue", "goog.async.nextTick", "goog.async.throwException"],
  false
);
goog.addDependency(
  "async/run_test.js",
...
goog.addDependency(
  "caja/string/html/htmlparser.js",
  [
    "goog.string.html",
...
goog.addDependency(
  "caja/string/html/htmlsanitizer.js",
  [
...
goog.addDependency(
  "crypt/ctr_test.js",
  ["goog.crypt.CtrTest"],
  ["goog.crypt", "goog.crypt.Aes", "goog.crypt.Ctr", "goog.testing.jsunit"],
  false
);
...
goog.addDependency("dom/attr.js", ["goog.dom.Attr"], [], false);
goog.addDependency(
...
goog.addDependency(
  "dom/forms.js",
  ["goog.dom.forms"],
  ["goog.dom.InputType", "goog.dom.TagName", "goog.structs.Map", "goog.window"],
  false
);
goog.addDependency(
  "dom/forms_test.js",
...
goog.addDependency(
  ...
  ["goog.dom", "goog.dom.TagName", "goog.editor.Table", "goog.testing.jsunit"],
  false
);
goog.addDependency(
...
goog.addDependency(
  "html/safehtmlformatter.js",
  ["goog.html.SafeHtmlFormatter"],
  ["goog.asserts", "goog.dom.tags", "goog.html.SafeHtml", "goog.string"],
  false
);
goog.addDependency(
  "html/safehtmlformatter_test.js",
  ["goog.html.safeHtmlFormatterTest"],
  [
    "goog.html.SafeHtml",
    "goog.html.SafeHtmlFormatter",
    "goog.string",
...
goog.addDependency(
  "html/sanitizer/csssanitizer.js",
...
goog.addDependency(
  "html/sanitizer/htmlsanitizer.js",
  [
...
goog.addDependency(
  "html/sanitizer/tagblacklist.js",
  ["goog.html.sanitizer.TagBlacklist"],
  [],
  false
);
goog.addDependency(
  "html/sanitizer/tagwhitelist.js",
  ["goog.html.sanitizer.TagWhitelist"],
  [],
  false
);
goog.addDependency(
  "html/sanitizer/unsafe.js",
...
goog.addDependency(
  ...
  [
    ...
    "goog.i18n.CompactNumberFormatSymbols_yue_HK",
...
goog.addDependency(
  ...
  [
    ...
    "goog.i18n.DateTimePatterns_yue_HK",
...
goog.addDependency(
  ...
  [
    ...
    "goog.i18n.DateTimeSymbols_yue_HK",
...
goog.addDependency(
  ...
  [
    ...
    "goog.i18n.NumberFormatSymbols_yue_HK",
...
goog.addDependency(
  "labs/mock/verificationmode_test.js",
  ["goog.labs.mock.VerificationModeTest"],
  ["goog.labs.mock.verification", "goog.testing.testSuite"],
  true
);
goog.addDependency(
  "labs/net/image.js",
...
goog.addDependency(
  "labs/promise/promise.js",
  ["goog.labs.promise"],
  ["goog.Promise"],
  true
);
goog.addDependency(
  "labs/promise/promise_test.js",
  ["goog.labs.promiseTest"],
  [
    "goog.Promise",
    "goog.Timer",
    "goog.labs.promise",
...
goog.addDependency(
  ...
  ["goog.array", "goog.asserts", "goog.object"],
  false
);
goog.addDependency(
...
goog.addDependency(
  ...
  ["goog.array", "goog.labs.structs.Map", "goog.object"],
  false
);
goog.addDependency(
...
goog.addDependency(
  "labs/testing/json_fuzzing.js",
  ["goog.labs.testing.JsonFuzzing"],
  ["goog.string", "goog.testing.PseudoRandom"],
  false
);
goog.addDependency(
  "labs/testing/json_fuzzing_test.js",
  ["goog.labs.testing.JsonFuzzingTest"],
  [
    "goog.json",
    "goog.labs.testing.JsonFuzzing",
    "goog.testing.asserts",
...
goog.addDependency(
  "labs/useragent/verifier.js",
  ["goog.labs.useragent.verifier"],
  [],
  false
);
goog.addDependency(
  "labs/useragent/verifier_test.js",
  ["goog.labs.useragent.verifierTest"],
  [
    "goog.labs.userAgent.browser",
    "goog.labs.useragent.verifier",
    "goog.testing.testSuite",
...
goog.addDependency(
  "math/box.js",
  ["goog.math.Box"],
  ["goog.asserts", "goog.math.Coordinate"],
  false
);
goog.addDependency(
  "math/box_test.js",
...
goog.addDependency("math/irect.js", ["goog.math.IRect"], [], false);
goog.addDependency(
  "math/line.js",
  ["goog.math.Line"],
  ["goog.math", "goog.math.Coordinate"],
...
goog.addDependency("math/long.js", ["goog.math.Long"], ["goog.reflect"], false);
goog.addDependency(
  "math/long_test.js",
  ["goog.math.LongTest"],
...
goog.addDependency(
  "math/matrix.js",
  ["goog.math.Matrix"],
  ["goog.array", "goog.asserts", "goog.math", "goog.math.Size", "goog.string"],
  false
);
goog.addDependency(
  "math/matrix_test.js",
...
goog.addDependency(
  "messaging/portchannel_test.js",
  ["goog.messaging.PortChannelTest"],
  [
    "goog.Promise",
    "goog.Timer",
    "goog.dom",
...
goog.addDependency(
  "messaging/portnetwork_test.js",
  ["goog.messaging.PortNetworkTest"],
  [
    "goog.Promise",
    "goog.Timer",
    "goog.labs.userAgent.browser",
...
goog.addDependency(
  "mochikit/async/deferredlist.js",
...
goog.addDependency(
  "net/streams/base64pbstreamparser.js",
  ["goog.net.streams.Base64PbStreamParser"],
  [
    "goog.asserts",
...
goog.addDependency(
  "net/streams/base64pbstreamparser_test.js",
  ["goog.net.streams.Base64PbStreamParserTest"],
  [
    "goog.crypt.base64",
    "goog.net.streams.Base64PbStreamParser",
    "goog.object",
...
goog.addDependency(
  "net/streams/base64streamdecoder.js",
  ["goog.net.streams.Base64StreamDecoder"],
  ["goog.asserts", "goog.crypt.base64"],
  false
);
goog.addDependency(
  "net/streams/base64streamdecoder_test.js",
  ["goog.net.streams.Base64StreamDecoderTest"],
  [
    "goog.net.streams.Base64StreamDecoder",
    "goog.testing.asserts",
    "goog.testing.jsunit",
...
goog.addDependency(
  "net/streams/jsonstreamparser.js",
  ["goog.net.streams.JsonStreamParser"],
  ["goog.asserts", "goog.json", "goog.net.streams.StreamParser"],
  false
);
goog.addDependency(
  "net/streams/jsonstreamparser_test.js",
  ["goog.net.streams.JsonStreamParserTest"],
  [
    "goog.array",
    "goog.json",
    "goog.labs.testing.JsonFuzzing",
...
goog.addDependency(
  "net/streams/pbstreamparser.js",
  ["goog.net.streams.PbStreamParser"],
  ["goog.asserts", "goog.net.streams.StreamParser"],
  false
);
goog.addDependency(
  "net/streams/pbstreamparser_test.js",
  ["goog.net.streams.PbStreamParserTest"],
  [
    "goog.net.streams.PbStreamParser",
    "goog.object",
    "goog.testing.asserts",
...
goog.addDependency(
  "net/streams/streamparser.js",
  ["goog.net.streams.StreamParser"],
  [],
  false
);
goog.addDependency(
  "net/streams/xhrnodereadablestream.js",
  ["goog.net.streams.XhrNodeReadableStream"],
  [
    "goog.array",
    "goog.log",
...
goog.addDependency(
  "net/streams/xhrnodereadablestream_test.js",
  ["goog.net.streams.XhrNodeReadableStreamTest"],
  [
    "goog.net.streams.NodeReadableStream",
    "goog.net.streams.XhrNodeReadableStream",
    "goog.net.streams.XhrStreamReader",
...
goog.addDependency(
  "net/streams/xhrstreamreader.js",
  ["goog.net.streams.XhrStreamReader"],
  [
    "goog.events.EventHandler",
    "goog.log",
...
goog.addDependency(
  "net/streams/xhrstreamreader_test.js",
  ["goog.net.streams.XhrStreamReaderTest"],
  [
    "goog.net.ErrorCode",
    "goog.net.XmlHttp",
    "goog.net.streams.XhrStreamReader",
...
goog.addDependency(
  "pubsub/pubsub.js",
  ["goog.pubsub.PubSub"],
  ["goog.Disposable", "goog.array", "goog.async.run"],
  false
);
goog.addDependency(
...
goog.addDependency(
  "reflect/reflect_test.js",
  ["goog.reflectTest"],
  ["goog.object", "goog.reflect", "goog.testing.jsunit"],
  false
);
goog.addDependency(
...
goog.addDependency(
  ...
  ["goog.iter", "goog.iter.StopIteration", "goog.testing.asserts"],
  false
);
goog.addDependency(
...
goog.addDependency(
  "string/linkify.js",
  ["goog.string.linkify"],
  ["goog.html.SafeHtml", "goog.string"],
  false
);
goog.addDependency(
...
goog.addDependency(
  "testing/asserts.js",
  ["goog.testing.JsUnitException", "goog.testing.asserts"],
...
goog.addDependency(
  ...
  ["goog.dom", "goog.testing.fs.Blob", "goog.testing.jsunit"],
  false
);
goog.addDependency(
...
goog.addDependency(
  ...
  ["goog.testing.fsTest"],
  ["goog.testing.fs", "goog.testing.fs.Blob", "goog.testing.jsunit"],
  false
);
goog.addDependency(
...
goog.addDependency(
  "testing/mockutil.js",
  ["goog.testing.MockUtil"],
  ["goog.object", "goog.structs.Set"],
  false
);
goog.addDependency(
  "testing/mockutil_test.js",
  ["goog.testing.MockUtilTest"],
  ["goog.testing.MockUtil", "goog.testing.jsunit"],
  false
);
goog.addDependency(
...
goog.addDependency(
  "testing/multitestrunner_test.js",
  ["goog.testing.MultiTestRunnerTest"],
  [
    "goog.Promise",
    "goog.events",
    "goog.testing.MockControl",
...
goog.addDependency(
  ...
  ["goog.testing.parallelClosureTestSuite"],
  [
    "goog.Promise",
    "goog.events",
    "goog.testing.MultiTestRunner",
...
goog.addDependency(
  "testing/parallel_closure_test_suite_test.js",
  ["goog.testing.parallelClosureTestSuiteTest"],
  [
    "goog.dom",
    "goog.testing.MockControl",
    "goog.testing.MultiTestRunner",
...
goog.addDependency(
  ...
  ["goog.testing.TestRunner"],
  ["goog.dom", "goog.dom.TagName", "goog.testing.TestCase"],
  false
);
goog.addDependency(
...
goog.addDependency(
  ...
  ["goog.ui.ac.RichRemoteArrayMatcher"],
  ["goog.dom", "goog.ui.ac.RemoteArrayMatcher"],
  false
);
goog.addDependency(
...
goog.addDependency(
  ...
  ["goog.array", "goog.html.TrustedResourceUrl"],
  false
);
goog.addDependency(
...
goog.addDependency(
  ...
  ["goog.vec", "goog.vec.Quaternion", "goog.vec.vec3d", "goog.vec.vec4d"],
  false
);
goog.addDependency(
  "vec/mat4f.js",
  ["goog.vec.mat4f", "goog.vec.mat4f.Type"],
  ["goog.vec", "goog.vec.Quaternion", "goog.vec.vec3f", "goog.vec.vec4f"],
  false
);
goog.addDependency(
  "vec/quaternion.js",
  ["goog.vec.Quaternion", "goog.vec.Quaternion.AnyType"],
  ["goog.vec", "goog.vec.Vec3", "goog.vec.Vec4"],
  false
);

((() => {
  ...
  class v {
    ...
    attributeChangedCallback(b, a, c, d, e) {
        ...
        if ((c = b.a.get(a.localName))) {
          ...
          if (c.attributeChangedCallback)
            for (c = c.observedAttributes, d = 0; d < c.length; d++) {
              const e = c[d], f = a.getAttribute(e);
  ...
  function va() {
      ...
      Object.defineProperty(a, "textContent", {
        ...
        set(a) {
          if (this.nodeType === Node.TEXT_NODE) d.set.call(this, a);
            ...
            var c = void 0;
            if (this.firstChild) {
              const e = this.childNodes, l = e.length;
              if (0 < l && p(this))
                for (let c = Array(l), g = 0; g < l; g++) c[g] = e[g];
            }
            d.set.call(this, a);
    ...
    u(Node.prototype, "replaceChild", function (a, d) {
      ...
      const e = p(a), c = M.call(this, a, d), m = p(this);
      m && B(b, d);
      e && B(b, a);
      m && z(b, a);
      return c;
    ...
    P && P.get
      ...
      : w(b, b => {
          a(b, {
            ...
            set(a) {
              const b = "template" === this.localName, d = b ? this.content : this, c = H.call(document, this.localName);

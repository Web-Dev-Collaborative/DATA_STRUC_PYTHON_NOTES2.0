(function () {
  ...
  function eb(a, b) {
    if (db()) for (; a.lastChild; ) a.removeChild(a.lastChild);
    a.innerHTML = b;
  }
  function fb() {
...
*/
  ...
  function Lb(a, b, c, d, e) {
    ...
    c = Nb(c);
    return a && a[Cb]
      ? a.a.add(String(b), c, !1, v(d) ? !!d.capture : !!d, e)
      : Ob(a, b, c, !1, d, e);
  }
  ...
  function Mb(a, b, c, d, e) {
    ...
    c = Nb(c);
    return a && a[Cb]
      ? a.a.add(String(b), c, !0, v(d) ? !!d.capture : !!d, e)
      : Ob(a, b, c, !0, d, e);
  }
  function Ub(a) {
    if ("number" != typeof a && a && !a.o) {
      ...
      if (b && b[Cb]) Hb(b.a, a);
        ...
        b.removeEventListener
          ...
          : b.detachEvent
          ? b.detachEvent(Rb(c), d)
          : b.addListener && b.removeListener && b.removeListener(d);
        Kb--;
        (c = Pb(b))
          ? (Hb(c, a), 0 == c.b && ((c.src = null), (b[Ib] = null)))
          : Fb(a);
      }
    }
  }
    ...
    if (!qb) {
      ...
      if (!(0 > d.keyCode || void 0 != d.returnValue)) {
        ...
        for (e = 0; e < d.length; e++)
          (b.a = d[e]), (f = Vb(d[e], a, !1, b)), (c = c && f);
      }
      return c;
    }
    return Wb(a, new W(b, this));
  }
  function Pb(a) {
    a = a[Ib];

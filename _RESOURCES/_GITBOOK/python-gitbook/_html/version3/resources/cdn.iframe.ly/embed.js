! function(e) {
    ...
    t.getEndpoint = function(e, t, r) {
        ...
        if (/^(https?:)?\/\//i.test(e) || (n = (t.CDN || i.CDN) + n, delete t.CDN), /^(?:https?:)?\/\//i.test(n) || (n = "//" + n), t && (n = o(n, t)), r && r.length) {
            for (var a = {}, d = Object.keys(i.config), s = 0; s < d.length; s++) {
                var l = d[s];
                c(r, l) && (a[l] = i.config[l])
            }
            n = o(n, a)
        }
    ...
    function o(e, t, r) {
        ...
        if (o) a = i.getWidget(t), n.cancelWidget(a || {
            ...
            var u, p;
            if ((a = document.createElement("div")).innerHTML = e.html, l && !s ? (u = l.aspectWrapper.parentNode, p = l.aspectWrapper, l.maxWidthWrapper.removeAttribute("style")) : (u = t.parentNode, p = t), d) {
                ...
                function e(t) {
                    ...
                    var i, n, a, o = [],
                        d = t.childNodes;
                    for (a = 0; d[a]; a++) n = d[a], s = "script", !(c = n).nodeName || c.nodeName.toUpperCase() !== s.toUpperCase() || n.type && "text/javascript" !== n.type.toLowerCase() && "application/javascript" !== n.type.toLowerCase() ? e(n) : (o.push(n), t.removeChild(n));
                    var c, s;
                    for (a = 0; o[a]; a++)(i = o[a]).parentNode && i.parentNode.removeChild(i), r(o[a])
                }(a);
            u.removeChild(p), s && setTimeout(function() {
                c(u)
            ...
            t.length > 1 && function(e) {
                ...
                function l(e) {
                    ...
                    if (!p) {
                        ...
                        l.CDN = f && f[0], c ? JSON.stringify(l, Object.keys(l).sort()) !== JSON.stringify(c, Object.keys(c).sort()) && (p = !0) : c = l
                    }
                    if (p) n.trigger("load", e);
                    else if (d) e.setAttribute("data-import-uri", d), -1 === o.indexOf(d) && o.push(d), s(d, e);
                    else {
                        u || (u = e.getAttribute("href"));
                        var m = c.key || c.api_key || n.config.api_key || n.config.key;
                        m && u ? (e.setAttribute("data-import-uri", u), -1 === r.indexOf(u) && r.push(u), s(u, e)) : n.trigger("load", e)
                    }
                }
                ...
                r.length > 0 || o.length > 0 ? ((c = c || {}).touch = n.isTouch(), c.flash = function() {
                    var e = !1;
                    try {
                    ...
                    return e
                }(), c.app = 1, r.length > 0 && (c.uri = r), o.length > 0 && (c.ids = o.join("&")), c.v = n.VERSION, t.src = i.getEndpoint("/api/import/v2", c, n.SUPPORTED_QUERY_STRING), t.onerror = function() {
                    d()
    ...
    }, n.on("import-widget-ready", c), n.addEventListener || (n.addEventListener = function(e, t, r) {
    ...
    n.on("load", function(e, t) {
        ...
        e && "A" === e.nodeName && (e.getAttribute("data-iframely-url") || e.getAttribute("href")) && !e.hasAttribute("data-import-uri") && function(e) {
            ...
            if (t) {
                ...
                if (c)
                    for (; c.aspectWrapper.lastChild;) c.aspectWrapper.removeChild(c.aspectWrapper.lastChild);
                else {
                    c = i.addDefaultWrappers(e);
                    var s = e.parentNode;
                    s.removeChild(e)
                }
                c.aspectWrapper.appendChild(a), o ? (a.setAttribute("data-iframely-url", t), n.trigger("load", a)) : (a.setAttribute("src", t), n.trigger("iframe-ready", a))
        ...
        if (e && "IFRAME" === e.nodeName && e.hasAttribute("data-iframely-url") && e.hasAttribute("data-img") && !e.getAttribute("src")) {
            ...
            ! function(e, t, r) {
                ...
                if (r && /^(https?:)?\/\//.test(r)) a = r;
                    ...
                    if (t.match(/\/api\/iframe/)) a = i.getEndpoint(t.match(/^(.+)\/api\/iframe/i)[1] + "/api/thumbnail", Object.assign({
                        url: o.url,
                        api_key: o.api_key,
                        key: o.key
                    }, d));
                    else {
                        if (!t.match(n.ID_RE)) return;
                        a = i.getEndpoint(t.replace(/^((?:https?:)?\/\/[^\/]+\/(\w+-?\w+))(?:\?.*)?$/, "$1/thumbnail"), d)
                    }
                }
                ...
                if (f && parseInt(f[1]) && p) {
                    ...
                    i.setStyles(m, {
                        ...
                        position: "relative",
                        paddingBottom: p
                    }), m.appendChild(s), e.aspectWrapper.appendChild(m)
                } else e.aspectWrapper.appendChild(s)
            }(r, a, t), a = i.addQueryString(a, {
                img: 1
            }), e.setAttribute("data-iframely-url", a), new s(r), n.trigger("load", e)
        }
    }), n.on("message", function(e, t) {
        var r;
        "widgetRendered" === t.method && (a(e), (r = c(e)) && r.deactivate()), "begin-waiting-widget-render" === t.method && (r = c(e)) && r.clearLoadingTimeout(), "end-waiting-widget-render" === t.method && (r = c(e)) && r.registerLoadingTimeout()
    });
    var o = [];
    ...
    s.prototype.iframeOnLoad = function() {
    ...
    }, s.prototype.clearLoadingTimeout = function() {
        this.timeoutId && clearTimeout(this.timeoutId), this.timeoutId = null
    }, s.prototype.registerLoadingTimeout = function() {
        if (!this.timeoutId) {
            var e = this;
            ...
            !a && t.height && (a = {
                ...
                function(e, t) {
                    if (t && Object.keys(t).length > 0 && e) {
                        ...
                        var c = window.getComputedStyle && window.getComputedStyle(e.iframe).getPropertyValue("height");
    ...
    }), i.openHref || (i.openHref = function(e) {
        0 === e.indexOf(window.location.origin) ? window.location.href = e : window.open(e, "_blank", "noopener")

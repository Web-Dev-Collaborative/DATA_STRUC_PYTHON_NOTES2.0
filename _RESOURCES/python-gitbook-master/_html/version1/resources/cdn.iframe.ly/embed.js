!(function (e) {
        ...
        (function () {
          for (
            var e = document.querySelectorAll(
                'script[src*="embed.js"], script[src*="iframely.js"]'
              ),
              t = 0;
            t < e.length;
            t++
  ...
  function (e, t, r) {
    ...
    (i.VERSION = 1),
      ...
      (i.ID_RE = /^(?:https?:)?\/\/[^\/]+\/(\w+-?\w+)(?:\?.*)?$/),
      (i.SCRIPT_RE =
        /^(?:https?:|file:\/)?\/\/[^\/]+(?:.+)?\/(?:embed|iframely)\.js(?:[^\/]+)?$/i),
      (i.CDN_RE =
      ...
      (i.LAZY_IFRAME_FADE_TIMEOUT = 200),
      (i.CLEAR_WRAPPER_STYLES_TIMEOUT = 3e3);
  },
  function (e, t, r) {
    (function (e) {
      var t = r(0),
                ...
                r ||
                  ((r = new IntersectionObserver(
                    ...
                    (function (e) {
                      var t = {};
                      return (
                        e && e.threshold && (t.threshold = e.threshold),
                        e &&
                          e.margin &&
                          (t.rootMargin =
                            e.margin +
        ...
        if (
          ...
          u.insertBefore(a, p),
            (function e(t) {
              ...
              var c, s;
              for (a = 0; o[a]; a++)
                (i = o[a]).parentNode && i.parentNode.removeChild(i), r(o[a]);
            })(a);
        u.removeChild(p),
          s &&
            setTimeout(function () {
          ...
          (function (e) {
            ...
            function l(e) {
              ...
              if (!p) {
                ...
                (l.CDN = f && f[0]),
                  c
                    ? JSON.stringify(l, Object.keys(l).sort()) !==
            ...
            if (t) {
              ...
              if (c)
                for (; c.aspectWrapper.lastChild; )
                  c.aspectWrapper.removeChild(c.aspectWrapper.lastChild);
              else {
        ...
        !a &&
          ...
          (function (e, t) {
            if (t && Object.keys(t).length > 0 && e) {
              var r = (function (e) {
                  var t =
                      (e.iframe && e.iframe.style.border) ||
                      (e.aspectWrapper && e.aspectWrapper.style.border),
                    r = (t && t.match(/(\d+)px/)) || 0;
    ...
    function d(e, t) {
      t && e && e.iframe
        ...
        : !t &&
          e &&
          e.iframe &&
          (i.setStyles(e.aspectWrapper, a), i.setStyles(e.iframe, o));
    }
  },
  function (e, t, r) {
    var i = r(0);

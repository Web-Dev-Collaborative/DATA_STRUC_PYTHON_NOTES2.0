  ...
  function (e, t, n) {
    ...
    !(function () {
      function e() {
        ...
        try {
          t =
            "function" == typeof n.getEntriesByType
              ? new URL(n.getEntriesByType("navigation")[0].name).pathname
              : h
              ? new URL(h).pathname
        ...
        return (
          g && g.version && (i.versions.fl = g.version),
          T &&
            ((i.lcp = T.lcp && void 0 !== T.lcp.value ? T.lcp : i.lcp),
            (i.fid = T.fid && void 0 !== T.fid.value ? T.fid : i.fid),
            (i.cls = T.cls && void 0 !== T.cls.value ? T.cls : i.cls)),
          g && (i.siteToken = g.token),
          i
        );
      }
      ...
      function t(e) {
        ...
        if (
          ((p.documentWriteIntervention = o()),
          (p.firstPaint = i("first-paint")),
          (p.firstContentfulPaint = i("first-contentful-paint")),
          (p.errorCount = window.__cfErrCount || 0),
          g && ((p.siteToken = g.token), (S = !0)),
          "function" == typeof n.getEntriesByType)
        ) {
          ...
          w.forEach(function (e) {
            ...
            p.tempResources &&
              void 0 === p.tempResources[E] &&
              (p.tempResources[E] = []);
            var n = JSON.stringify(t).length;
            T + n < 62e3 && p.tempResources
              ? ((T += n), p.tempResources[E].push(t))
              : (E++, (T = 0));
          });
        }
        return (
      ...
      if (!g || "single" !== g.load) {
        ...
        var T = {
          ...
          L = function (e) {
            ...
            if ("CLS" === e.name) {
              ...
              var n = E(e.entries);
              n &&
                ((T.cls.element = R(n.node)),
                (T.cls.currentRect = n.currentRect),
                (T.cls.previousRect = n.previousRect));
            } else if ("FID" === e.name) {
              T.fid = {
                value: e.value,
                path: t,
        ...
        if (n && g && g.token) {
          var A =
                  ...
                  (r.resources = e),
                    ...
                    g &&
                      ...
                      k &&
                        ...
                        m.length > 3 && m.shift()),
                      f.sendObjectBeacon("", r, function () {}, !1, A),
                      void 0 !== g.forward &&
            ...
            I = function (t) {
              var n = e();
              t || ((n.resources = []), delete n.tempResources),
                g && f.sendObjectBeacon("", n, function () {}, !0, A);
            },
            N = function () {
              S = !0;
              var e =
            ...
            k &&
              ...
              (function (e) {
                ...
                if (t) {
                  var i = function () {
                    (v = l()),
                      "function" == typeof n.clearResourceTimings &&
                        n.clearResourceTimings();
                  };

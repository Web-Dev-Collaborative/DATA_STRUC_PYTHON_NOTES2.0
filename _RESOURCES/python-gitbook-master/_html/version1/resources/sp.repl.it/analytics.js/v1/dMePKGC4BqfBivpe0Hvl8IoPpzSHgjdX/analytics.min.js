  ...
  })()(
    {
      ...
      4: [
        function (e, t, n) {
          "use strict";
          t.exports = {
            "@asayerio/analytics.js-integration-asayer": e(
              "@asayerio/analytics.js-integration-asayer"
            ),
            "@auryc/analytics.js-integration-auryc": e(
              "@auryc/analytics.js-integration-auryc"
            ),
            "@convertflow/analytics.js-integration-convertflow": e(
              "@convertflow/analytics.js-integration-convertflow"
            ),
            "@owneriq/analytics.js-integration-owneriq-pixel": e(
              "@owneriq/analytics.js-integration-owneriq-pixel"
            ),
            "@profitwell/analytics.js-integration": e(
              "@profitwell/analytics.js-integration"
            ),
            ...
            "google-analytics-4": e(
              "@segment/analytics.js-integration-google-analytics-4"
            ),
            ...
            "visual-tagger": e(
              "@segment/analytics.js-integration-visual-tagger"
            ),
            ...
            "@segment/mme-e2e-direct-destination": e(
              "@segment/mme-e2e-direct-destination"
            ),
            "@smartlook/analytics.js-integration-smartlook": e(
              "@smartlook/analytics.js-integration-smartlook"
            ),
            "@survicate/analytics.js-integration-survicate": e(
              "@survicate/analytics.js-integration-survicate"
            ),
            "@userpilot/analytics.js-integration-userpilot": e(
              "@userpilot/analytics.js-integration-userpilot"
            ),
            "@walkme/analytics.js-integration-walkme": e(
              "@walkme/analytics.js-integration-walkme"
            ),
            "analytics.js-integration-bouncex-test": e(
              "analytics.js-integration-bouncex-test"
            ),
            "analytics.js-integration-crisp": e(
      ...
      5: [
        function (e, t, n) {
          ...
          var o = {
            source: [
              e("@segment/analytics.js-middleware-braze-deduplicate"),
            ].map(function (e) {
        ...
        function (e, t, n) {
          t.exports = {
            ...
            checkoutStepCompleted:
              /^[ _]?checkout[ _]?step[ _]?completed[ _]?$/i,
            ...
            productAddedToWishlist:
              /^[ _]?product[ _]?added[ _]?to[ _]?wishlist[ _]?$/i,
            wishlistProductRemoved:
              /^[ _]?wishlist[ _]?product[ _]?removed[ _]?$/i,
            wishlistProductAddedToCart:
              /^[ _]?wishlist[ _]?product[ _]?added[ _]?to[ _]?cart[ _]?$/i,
            ...
            applicationBackgrounded:
              /^[ _]?application[ _]?backgrounded[ _]?$/i,
            ...
            pushNotificationReceived:
              /^[ _]?push[ _]?notification[ _]?received[ _]?$/i,
        ...
        function (e, t, n) {
          function o() {
            ...
            for (; t < 16; t++) {
              e = i[a + t];
              n +=
                6 == t ? r[(15 & e) | 64] : 8 == t ? r[(63 & e) | 128] : r[e];
              1 & t && t > 1 && t < 11 && (n += "-");
            }
            a++;
            return n;
          ...
          for (var i, a = 256, r = []; a--; )
            r[a] = (a + 256).toString(16).substring(1);
          n.v4 = o;
        },
        {},
      ],
          ...
          (function (o) {
            ...
            i.prototype.addDestinationMiddleware = function (e, t) {
              ...
              t.forEach(function (t) {
                n._destinationMiddlewares[e] ||
                  (n._destinationMiddlewares[e] = new f());
            ...
            i.prototype.identify = function (e, t, n, o) {
              ...
              this.options.integrations &&
                A(i.integrations, this.options.integrations);
            ...
            i.prototype.trackClick = i.prototype.trackLink = function (
              e,
              t,
              n
            ) {
            ...
            i.prototype.trackSubmit = i.prototype.trackForm = function (
              e,
              t,
              n
            ) {
                ...
                k(function (i, a) {
                  ...
                  if (r.enabled(a))
                    if (n.indexOf(a) >= 0)
                      ...
                      try {
                        o._integrationMiddlewares.applyMiddlewares(
                          r,
                          i.name,
                          function (t) {
                            if (null !== t) {
                              ...
                              if (o._destinationMiddlewares[i.name])
                                o._destinationMiddlewares[
                                  i.name
                                ].applyMiddlewares(r, i.name, function (t) {
                                  if (null !== t) {
                                    t instanceof u || (t = new u(t));
                                    w.increment(
      ...
      74: [
        function (e, t, n) {
          ...
          o.prototype._getIdFromLocalStorage = function () {
            return this._options.localStorageFallbackDisabled
              ? null
              : d.get(this._options.cookie.key);
          };
          ...
          o.prototype._setIdInLocalStorage = function (e) {
            this._options.localStorageFallbackDisabled ||
              d.set(this._options.cookie.key, e);
          };
          ...
          o.prototype._getTraits = function () {
            var e = this._options.persist
              ? d.get(this._options.localStorage.key)
              : this._traits;
            return e ? c(i(e)) : {};
          };
          o.prototype._setTraits = function (e) {
            ...
            this._options.persist
              ? d.set(this._options.localStorage.key, e)
              : (this._traits = e);
          };
        ...
        function (e, t, n) {
          ...
          function o(e, t) {
            ...
            r(function (e, t) {
              n(t) &&
                "object" !== l(b[t]) &&
                ((p.call(b, t) && "boolean" == typeof m[t]) || (b[t] = e));
            }, m);
            r(function (e, t) {
        ...
        function (e, t, n) {
          ...
          p.bigint = function (e) {
            return (
              ...
              "[object BigInt]" === r.call(e) &&
              "bigint" == typeof s.call(e)
            );
          };
          t.exports = p;
        },
        ...
        function (e, t, n) {
            ...
            n.onreadystatechange = function () {
              n.readyState === XMLHttpRequest.DONE &&
                (n.status >= 200 && n.status < 300
                  ? t(null, n.responseText ? f.parse(n.responseText) : null)
            ...
            n.onreadystatechange = function () {
              n.readyState === XMLHttpRequest.DONE &&
                (n.status >= 200 && n.status < 300
                  ...
                  : t(n.statusText || n.responseText || "Unknown Error", null));
            };
            n.send();
          }
          ...
          var u = e("./ads"),
            ...
            _ = (n = t.exports =
              p("Segment.io")
                ...
                .option("deleteCrossDomainId", !1)
                .option("saveCrossDomainIdInLocalStorage", !0)
                .option("retryQueue", !0)
          ...
          _.prototype.normalize = function (e) {
            ...
            if (this.isCrossDomainAnalyticsEnabled()) {
              ...
              u &&
                (r.traits
                  ? r.traits.crossDomainId || (r.traits.crossDomainId = u)
                  : (r.traits = {
                      crossDomainId: u,
                    }));
            }
            ...
            if (this.options.addBundledMetadata) {
              for (
                var d = h(this.analytics.Integrations),
                  c = this.options.maybeBundledConfigIds,
                  p = [],
                  f = 0;
                f < d.length;
                f++
          ...
          _.prototype.enqueue = function (e, t, n) {
            var o = "https://" + this.options.apiHost + e,
              ...
              a = this.normalize(t);
            f.stringify(a).length > 32e3 &&
              this.debug("message must be less than 32kb %O", a);
          ...
          _.prototype.retrieveCrossDomainId = function (e) {
            if (this.isCrossDomainAnalyticsEnabled()) {
              ...
              if (t)
                ...
                for (
                  var n = this, i = this.options.apiKey, a = [], r = 0;
                  r < this.options.crossDomainIdServers.length;
                  r++
                ) {
          ...
          _.prototype.getCachedCrossDomainId = function () {
            return this.options.saveCrossDomainIdInLocalStorage
              ? b("seg_xid")
              : this.cookie("seg_xid");
          };
          _.prototype.saveCrossDomainId = function (e) {
            if (this.options.saveCrossDomainIdInLocalStorage)
              for (
                var t = this, n = s(window.location.hostname), o = 0;
                ...
                if (s(i) === n) {
                  var a = this.options.apiKey,
                    u =
                      "https://" + i + "/v1/saveId?writeKey=" + a + "&xid=" + e;
                  r(u, function (n, o) {
                    n
                      ? t.debug("could not save id on %O, received %O", u, [
                          n,
                          o,
                        ])
                      : b("seg_xid", e);
        ...
        function (e, t, n) {
          ...
          i.prototype._processHead = function () {
            ...
            for (
              ...
              n.length && n[0].time <= i && d++ < e.maxItems;
          ...
          i.prototype._checkReclaim = function () {
            ...
            s(
              ...
              (function (e) {
                for (
                  var n = [], o = t._store.getOriginalEngine(), i = 0;
                  i < o.length;
                  i++
                ) {
                  var a = o.key(i),
      ...
      1309: [
        function (e, t, n) {
          ...
          function r(e, t, n) {
            ...
            y.sort();
            v.sort();
            for (r = y.length - 1; r >= 0; r--) if (y[r] != v[r]) return !1;
      ...
      1312: [
        function (e, t, n) {
          function o(e, t) {
            ...
            var a = Object.prototype.hasOwnProperty.call(r, o)
                ? r[o]
                : r._default,
              s = a[0],
              u = a[1],
      ...
      1324: [
        function (e, t, n) {
          ...
          var o =
            ...
            a = function (e) {
              return (
                !(o && e && "object" == typeof e && Symbol.toStringTag in e) &&
                "[object Arguments]" === i.call(e)
              );
            },
            r = function (e) {
              return (
                      ...
                      var I = function (e) {
                        ...
                        T = function (e, t, o, i, a, r, s) {
                          ...
                          "object" == typeof u &&
                            u &&
                            (u.getUTCFullYear &&
                            "[object Date]" == y.call(u) &&
                            u.toJSON === c.prototype.toJSON
                              ? (u = E(u))
                          ...
                          if ("object" == typeof u) {
                            for (g = s.length; g--; ) if (s[g] === u) throw f();
                            s.push(u);
                            p = [];
                            v = r;
                            r += a;
      ...
      1410: [
        function (e, t, n) {
          !(function (e) {
            ...
            "5d41402abc4b2a76b9719d911017c592" !== p(l("hello")) &&
              (v = function (e, t) {

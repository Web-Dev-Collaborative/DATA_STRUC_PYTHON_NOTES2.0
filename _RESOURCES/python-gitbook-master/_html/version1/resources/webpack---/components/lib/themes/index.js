...
const codesandbox_light_json_1 = __importDefault(
  require("./codesandbox-light.json")
);
const night_owl_json_1 = __importDefault(require("./night-owl.json"));
const nightOwlNoItalics_json_1 = __importDefault(
  require("./nightOwlNoItalics.json")
);
...
const solarized_light_json_1 = __importDefault(
  require("./solarized-light.json")
);
const shades_of_purple_1 = __importDefault(require("./shades-of-purple"));
const palenight_italic_json_1 = __importDefault(
  require("./palenight-italic.json")
);

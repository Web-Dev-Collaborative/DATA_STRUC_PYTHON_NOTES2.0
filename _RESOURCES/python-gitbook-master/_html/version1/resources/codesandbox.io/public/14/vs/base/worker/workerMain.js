...
(function () {
        ...
        return (
            ...
            if (r && !this._didPatchNodeRequire) {
              ...
              o.prototype._compile = function (t, s) {
                ...
                var c = new i._vm.Script(u, l),
                  ...
                  p = [this.exports, h, this, s, d, process, e.global, Buffer],
          ...
          (t.prototype._loadAndEvalScript = function (t, n, r, i, o, s, u, a) {
            ...
            return (
              ...
              d
                ? u()
                : a(new Error("Didn't receive define call in " + n + "!")),
              l
            );
          }),
  ...
  !(function (e) {
    ...
    r(e[12], t([0, 1, 15]), function (e, t, n) {
      "use strict";
        ...
        u = (function () {
          ...
          return (
              ...
              if (!s[0]) {
                ...
                return (
                  (p = s[0]
                    ...
                    : this.ComputeDiffRecursive(f + 1, t, d + 1, o, s)),
            ...
            (e.prototype.WALKTRACE = function (
              ...
              do {
                (b = M + e) === L || (b < N && c[b - 1] < c[b + 1])
                  ? ((m = (d = c[b + 1]) - M - i),
                    d < A && S.MarkNextChange(),
                    (A = d),
                    S.AddModifiedElement(d + 1, m),
                    (M = b + 1 - e))
                  : ((m = (d = c[b - 1] + 1) - M - i),
                    d < A && S.MarkNextChange(),
                    (A = d - 1),
                    S.AddOriginalElement(d, m + 1),
                    (M = b - 1 - e)),
                  P >= 0 &&
                    ((e = (c = this.m_forwardHistory[P])[0]),
                    (L = 1),
                    (N = c.length - 1));
              } while (--P >= -1);
              if (((C = S.getReverseChanges()), y[0])) {
                ...
                E = [new n.DiffChange(w, h - w + 1, D, g - D + 1)];
              } else {
                (S = new s()),
                  (L = u),
                  (N = a),
                ...
                do {
                  (b = M + o) === L || (b < N && f[b - 1] >= f[b + 1])
                    ? ((m = (d = f[b + 1] - 1) - M - l),
                      d > A && S.MarkNextChange(),
                      (A = d + 1),
                      S.AddOriginalElement(d + 1, m + 1),
                      (M = b + 1 - o))
                    : ((m = (d = f[b - 1]) - M - l),
                      d > A && S.MarkNextChange(),
                      (A = d),
                      S.AddModifiedElement(d + 1, m + 1),
                      (M = b - 1 - o)),
                    P >= 0 &&
                      ((o = (f = this.m_reverseHistory[P])[0]),
                      (L = 1),
                      (N = f.length - 1));
                } while (--P >= -1);
                E = S.getChanges();
            ...
            (e.prototype.ComputeRecursionPoint = function (
              ...
              for (f = 1; f <= g / 2 + 1; f++) {
                var A = 0,
                  P = 0;
                for (
                  d = this.ClipDiagonalBound(b - f, f, b, _),
                    h = this.ClipDiagonalBound(b + f, f, b, _),
                    N = d;
                  N <= h;
                  N += 2
                ) {
                ...
                for (
                  p = this.ClipDiagonalBound(C - f, f, C, _),
                    m = this.ClipDiagonalBound(C + f, f, C, _),
                    N = p;
                  N <= m;
                  N += 2
                ) {
                ...
                if (f <= 1447) {
                  var D = new Array(h - d + 2);
                  (D[0] = b - d + 1),
                    o.Copy(v, d, D, 1, h - d + 1),
            ...
            (e.prototype.PrettifyChanges = function (e) {
              ...
              for (var u = e.length - 1; u >= 0; u--) {
                ...
                if (u > 0) {
                  var a = e[u - 1];
                  a.originalLength > 0 &&
                    (n = a.originalStart + a.originalLength),
                    a.modifiedLength > 0 &&
                      (r = a.modifiedStart + a.modifiedLength);
                }
                for (
                  ...
                  if (
                    i &&
                    !this.OriginalElementsAreEqual(d, d + t.originalLength)
                  )
                    break;
                  if (
                    o &&
                    !this.ModifiedElementsAreEqual(h, h + t.modifiedLength)
                  )
                    break;
            ...
            (e.prototype._OriginalIsBoundary = function (e) {
              if (e <= 0 || e >= this.OriginalSequence.getLength() - 1)
                return !0;
            ...
            (e.prototype._ModifiedIsBoundary = function (e) {
              if (e <= 0 || e >= this.ModifiedSequence.getLength() - 1)
                return !0;
    ...
    r(e[10], t([0, 1, 11]), function (e, t, n) {
      "use strict";
      ...
      var i = (function () {
        ...
        return (
          Object.defineProperty(e.prototype, "toDispose", {
            get: function () {
      ...
      if (
        ...
        if (c)
          try {
            ...
            (u = f.locale),
              (a = d || t.LANGUAGE_DEFAULT),
              (l = f._translationsConfigFile);
          } catch (e) {}
        o = !0;
      } else if ("object" == typeof navigator) {
        var h = navigator.userAgent;
        (n = h.indexOf("Windows") >= 0),
          (r = h.indexOf("Macintosh") >= 0),
          (i = h.indexOf("Linux") >= 0),
          (s = !0),
          (a = u = navigator.language);
      }
      t.PlatformToString = function (e) {
        switch (e) {
          case 0:
            return "Web";
          case 1:
    ...
    r(e[14], t([0, 1]), function (e, t) {
        ...
        (t.compareIgnoreCase = function (e, t) {
          for (var n = Math.min(e.length, t.length), r = 0; r < n; r++) {
            ...
            if (i !== a) {
              ...
              var l = i - a;
              if (0 !== l)
                return s(i) && s(a) ? l : o(e.toLowerCase(), t.toLowerCase());
            }
          }
          return e.length < t.length ? -1 : e.length > t.length ? 1 : 0;
        }),
        (t.isLowerAsciiLetter = s),
        (t.isUpperAsciiLetter = u),
        (t.equalsIgnoreCase = function (e, t) {
          return (e ? e.length : 0) === (t ? t.length : 0) && l(e, t);
        }),
        (t.startsWithIgnoreCase = function (e, t) {
          var n = t.length;
          return !(t.length > e.length) && l(e, t, n);
        }),
      ...
      (t.removeAnsiEscapeCodes = function (e) {
        return (
          e && (e = (e = (e = e.replace(_, "")).replace(v, "")).replace(y, "")),
          e
        );
      }),
        (t.UTF8_BOM_CHARACTER = String.fromCharCode(65279)),
        (t.startsWithUTF8BOM = d),
        ...
        (t.uppercaseFirstLetter = function (e) {
  ...
  r(e[8], t([0, 1, 5]), function (e, t, n) {
    "use strict";

    function r(e, t, n) {
      void 0 === n && (n = 0);
      for (var r = void 0, i = -1, o = n; o < e.length; o++) {
        ...
        if (
          ...
          -1 !== i && ((r += encodeURIComponent(e.substring(i, o))), (i = -1)),
    ...
    function i(e) {
      return e.authority && e.path.length > 1 && "file" === e.scheme
        ? "//" + e.authority + e.path
        : e.path;
    }
    ...
    function s(e, t) {
      ...
      if (u) {
        ...
        if (u.length >= 3 && 47 === u.charCodeAt(0) && 58 === u.charCodeAt(2)) {
          (p = u.charCodeAt(1)) >= 65 && p <= 90
            ? ((u = "/" + String.fromCharCode(p + 32) + ":" + u.substr(3)),
              (d = 3))
            : p >= 97 && p <= 122 && (d = 3);
        } else if (u.length >= 2 && 58 === u.charCodeAt(1)) {
          var p = u.charCodeAt(0);
          p >= 65 && p <= 90
            ? ((u = String.fromCharCode(p + 32) + ":" + u.substr(2)), (d = 2))
            : p >= 97 && p <= 122 && (d = 2);
        }
        ("file" !== o || (u.length > d && 47 !== u.charCodeAt(d))) && (d = 0),
          (i += n(u, !0, d));
      }
      return (
        a && ((i += "?"), (i += n(a, !1))),
    ...
    var u,
      ...
      c = /^\/\//,
      f = !0;
    t.setUriThrowOnMissingScheme = function (e) {
      var t = f;
      return (f = e), t;
    };
    var d = "",
        ...
        return (
          ...
          (e.parse = function (e) {
            ...
            return t
              ? new g(
                  t[2] || d,
                  decodeURIComponent(t[4] || d),
                  decodeURIComponent(t[5] || d),
                  decodeURIComponent(t[7] || d),
                  decodeURIComponent(t[9] || d)
                )
              : new g(d, d, d, d, d);
          }),
          (e.file = function (e) {
      ...
      t(
        ...
        function (e, t, n, r, i, o) {
          ...
          function u(e, t) {
            var n;
            (n =
              t && "object" == typeof t && "function" == typeof t.then ? I : R),
              (e._value = t),
              e._setState(n);
          }
          ...
          function p(e, t, n, r) {
            (e._value = t), _(e, t, n, r), e._setState(T);
          }
          ...
          (w = {
            ...
            (I = {
              ...
              enter: function (e) {
                var t = e._value;
                if (t instanceof K && t._state !== F && t._state !== U)
                  y(t, {
                    promise: e,
                  });
                else {
            ...
            (k = {
              ...
              enter: function (e) {
                var t = new Error(M);
                (t.name = t.message), (e._value = t), e._setState(T);
              },
              cancel: s,
              done: s,
              then: s,
          ...
          var q,
            ...
            B = n.Class.define(
              ...
              },
              {
                cancel: function () {},
                  ...
                  (n instanceof Error && n.message === M) || H._doneHandler(n);
                },
                then: function (e, t) {
                  if (!t) return this;
                  var n,
                    r = this._value;
                  try {
                    t.handlesOnError || _(null, r, l, this, t),
                      (n = new Y(t(r)));
                  } catch (e) {
                    n = e === r ? this : new V(e);
                  }
            ...
            H = n.Class.derive(
              ...
              },
              {
                ...
                _veryExpensiveTagWithStack_tag: P,
                _getStack: function () {
          ...
          return (
            Object.defineProperties(H, i.createEventProperties(N)),
  ...
  r(e[21], t([0, 1, 4, 3]), function (e, t, n, r) {
    "use strict";
    ...
    function l(e, t, n) {
      function r(e, t, n) {
        ...
        if (0 !== t || 0 !== n.length) {
          var o = i[i.length - 1];
          o && o.start + o.deleteCount === e
            ? ((o.deleteCount += t), (r = o.toInsert).push.apply(r, n))
            : i.push({
                start: e,
                deleteCount: t,
                toInsert: n,
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      (t.findFirstInSorted = i),
      (t.mergeSort = o),
      (t.groupBy = function (e, t) {
        for (var n, r = [], i = 0, s = o(e.slice(0), t); i < s.length; i++) {
          var u = s[i];
      ...
      (t.sortedDiff = l),
      (t.delta = function (e, t, n) {
        for (var r = [], i = [], o = 0, s = l(e, t, n); o < s.length; o++) {
          var u = s[o];
          r.push.apply(r, e.slice(u.start, u.start + u.deleteCount)),
            i.push.apply(i, u.toInsert);
        }
        return {
          removed: r,
          added: i,
      ...
      (t.topAsync = function (e, t, i, o, s) {
        var l = this;
        return 0 === i
          ? r.TPromise.as([])
          : new r.TPromise(function (r, f) {
              u(l, void 0, void 0, function () {
                var r, u, l, f;
                return a(this, function (a) {
                  switch (a.label) {
                    case 0:
                      (r = e.length),
                        (u = e.slice(0, i).sort(t)),
                        (l = i),
                        (f = Math.min(i + o, r)),
                        (a.label = 1);
                    case 1:
                    ...
                    case 2:
                      a.sent(), (a.label = 3);
                    case 3:
                      if (s && s.isCancellationRequested) throw n.canceled();
                      c(e, t, u, l, f), (a.label = 4);
                    case 4:
                      return (l = f), (f = Math.min(f + o, r)), [3, 1];
                    case 5:
                      return [2, u];
                  }
                });
      ...
      (t.commonPrefixLength = function (e, t, n) {
        ...
        for (
          var r = 0, i = 0, o = Math.min(e.length, t.length);
          i < o && n(e[i], t[i]);
          i++
        )
          r++;
    ...
    r(e[9], t([0, 1, 4, 11, 10, 17, 3]), function (e, t, n, r, i, s, l) {
      "use strict";
      ...
      var _ = (function (e) {
        ...
        return (
          o(t, e),
          (t.prototype.fireAsync = function (e) {
            return u(this, void 0, void 0, function () {
              var t, r, i, o, s, u;
              return a(this, function (a) {
                switch (a.label) {
                  case 0:
                    if (!this._listeners) return [2];
                    for (
                      this._asyncDeliveryQueue ||
                        (this._asyncDeliveryQueue = []),
                        t = this._listeners.iterator(),
                        r = t.next();
                      !r.done;
                      r = t.next()
                    )
                      (u = []),
                        this._asyncDeliveryQueue.push([
                          ...
                          e(
                            u,
                            "function" == typeof r.value ? r.value : r.value[0]
                          ),
                          u,
                        ]);
                    a.label = 1;
                  case 1:
                    ...
                    (i = this._asyncDeliveryQueue.shift()),
                      (o = i[0]),
                      (s = i[1]),
                      (u = i[2]);
                    try {
                      ...
                      return n.onUnexpectedError(e), [3, 1];
                    }
                    return Object.freeze(u), [4, Promise.all(u)];
                  case 2:
                    return a.sent(), [3, 1];
                  case 3:
                    return [2];
      ...
      var b = (function () {
        ...
        return (
          ...
          (e.prototype.latch = function () {
            return new e(p(this._event));
          }),
          (e.prototype.on = function (e, t, n) {
            return this._event(e, t, n);
          }),
          (e.prototype.once = function (e, t, n) {
            return c(this._event)(e, t, n);
          }),
          e
        );
      })();
    ...
    r(e[29], t([0, 1, 4, 10, 3, 5]), function (e, t, n, r, i, s) {
      "use strict";
      Object.defineProperty(t, "__esModule", {
        value: !0,
      });
        ...
        c = (function (e) {
          function t(t, n) {
            ...
            "function" == typeof self.require.getConfig
              ...
              (r._lazyProxy = new i.TPromise(function (e, t) {
                (o = e), (s = t);
              })),
              (r._onModuleLoaded = r._protocol.sendMessage(u, [
                r._worker.getId(),
                n,
                a,
              ])),
      ...
      (t.SimpleWorkerServer = f),
        (t.create = function (e) {
          return new f(e, null);
        });
    }),
    r(e[2], t([0, 1]), function (e, t) {
      "use strict";
      Object.defineProperty(t, "__esModule", {
        value: !0,
      });
    ...
    r(e[19], t([0, 1, 7, 2]), function (e, t, n, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", {
        value: !0,
      });
    ...
    r(e[23], t([0, 1, 12, 14]), function (e, t, n, r) {
      "use strict";
            ...
            (e.prototype.getCharSequence = function (e, t, n) {
              for (var r = [], i = [], o = [], s = 0, u = t; u <= n; u++)
                for (
                  ...
                  (r[s] = l.charCodeAt(d - 1)), (i[s] = u + 1), (o[s] = d), s++;
              return new a(r, i, o);
            }),
            e
          );
        ...
        c = (function () {
          ...
          return (
            (e.createFromDiffResult = function (t, n, r, o, u, a, c) {
              ...
              if (
                (0 === n.originalLength
                  ? ((f = r.getStartLineNumber(n.originalStart) - 1), (d = 0))
                  : ((f = r.getStartLineNumber(n.originalStart)),
          ...
          return (
            (e.prototype.computeDiff = function () {
              ...
              for (var o = [], s = 0, a = 0, n = -1, l = e.length; n < l; n++) {
                for (
                  var f = n + 1 < l ? e[n + 1] : null,
                    d = f ? f.originalStart : this.originalLines.length,
                    h = f ? f.modifiedStart : this.modifiedLines.length;
                  s < d && a < h;
                  ...
                  if (p !== m) {
                    for (
                      var g = u._getFirstNonBlankColumn(p, 1),
                        _ = u._getFirstNonBlankColumn(m, 1);
                      g > 1 && _ > 1;

                    ) {
                      if (
                        (E = p.charCodeAt(g - 2)) !== (S = m.charCodeAt(_ - 2))
                      )
                        break;
                      g--, _--;
                    }
    ...
    r(e[25], t([0, 1, 22, 6]), function (e, t, n, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", {
        value: !0,
      });
      ...
      function (e, t, n, r, i, o, s, u, a, l, c) {
        ...
        !(function (e) {
          (e[(e.Hint = 1)] = "Hint"),
            ...
            (e[(e.Error = 8)] = "Error");
        })((d = t.MarkerSeverity || (t.MarkerSeverity = {})));
        var h = (function () {
          function e() {}
          return (
    ...
    r(e[16], t([0, 1, 28, 2]), function (e, t, n, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", {
        value: !0,
      });
    ...
    r(
      e[30],
      t([0, 1, 8, 3, 7, 23, 12, 2, 16, 25, 26, 24, 27, 5, 21]),
      function (e, t, n, r, i, s, u, a, l, c, f, d, h, p, m) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
          value: !0,
        });
            ...
            return (
              ...
              (t.prototype.computeMoreMinimalEdits = function (e, n) {
                ...
                for (
                  var s,
                    a = [],
                    l = 0,
                    c = (n = m.mergeSort(n, function (e, t) {
                  ...
                  var f = c[l],
                    ...
                    h = f.text,
                    p = f.eol;
                  if (("number" == typeof p && (s = p), d)) {
                    var g = o.getValueInRange(d);
                    if (((h = h.replace(/\r\n|\n|\r/g, o.eol)), g !== h))
                      if (Math.max(h.length, g.length) > t._diffLimit)
                        a.push({
                          range: d,
                          text: h,
                        });
                        ...
                        for (
                          var _ = u.stringDiff(g, h, !1),
                            v = o.offsetAt(i.Range.lift(d).getStartPosition()),
                            y = 0,
                            b = _;
                          y < b.length;
                          y++
                          ...
                          var C = b[y],
                            E = o.positionAt(v + C.originalStart),
                            S = o.positionAt(
                          ...
                          o.getValueInRange(L.range) !== L.text && a.push(L);
                        }
                  }
                }
                return (
              ...
              (t.prototype.textualSuggest = function (e, n, i, o) {
                ...
                if (s) {
                  var u = [],
                    a = new RegExp(i, o),
                    l = s.getWordUntilPosition(n, a),
                    c = Object.create(null);
                  c[l.word] = !0;
                  for (
                    var f = s.createWordIterator(a), d = f.next();
                    !d.done && u.length <= t._suggestionsLimit;
                    d = f.next()
                  ) {
                    var h = d.value;
                    c[h] ||
              ...
              (t.prototype.navigateValueSet = function (e, t, n, i, o) {
                ...
                var d = f.BasicInplaceReplace.INSTANCE.navigateValueSet(
                  t,
                  a,
                  l,
                  c,
        ...
        var v = (function (e) {
          ...
          return (
            ...
            (t.prototype.acceptRemovedModel = function (e) {
              this._models[e] &&
                (this.removedListeners.forEach(function (t) {
                  return t(e);
                }),
        ...
        (t.EditorSimpleWorkerImpl = v),
          (t.create = function () {
            return new v(null);
          }),
          "function" == typeof importScripts &&
            (p.globals.monaco = h.createMonacoBaseAPI());
      }
    ),
    (function () {
      "use strict";

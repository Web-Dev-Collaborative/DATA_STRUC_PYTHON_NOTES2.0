        ...
        var n = /^#*@(t|r)$/,
                ...
                var u =
                  null ===
                    (r =
                      null ===
                        (t =
                          null === e || void 0 === e ? void 0 : e.__proto__) ||
                      void 0 === t
                        ? void 0
              ...
              (e.prototype._handleValue = function (e, t, r) {
                try {
                  ...
                  for (var s = 0, u = this.transforms; s < u.length; s++) {
                    var f = u[s];
                    if (f.shouldTransform(o, n))
                      return this._applyTransform(n, t, r, f);
                  }
              ...
              (e.prototype.transform = function () {
                for (
                  var t = this,
                    ...
                    n = 0,
                    o = this.circularCandidatesDescrs;
                  n < o.length;
                  n++
                ) {
                  var a = o[n];
                  a.refIdx > 0 &&
                    ((r[a.refIdx] = a.parent[a.key]),
                    (a.parent[a.key] = e._createRefMark(a.refIdx)));
                }
                return r;
              }),
              e
          ...
          d = (function () {
            ...
            return (
              (e.prototype._handlePlainObject = function (e) {
                ...
                e))
                  e.hasOwnProperty(r) &&
                    (this._handleValue(e[r], e, r),
                    n.test(r) && ((t[r.substring(1)] = e[r]), delete e[r]));
              ...
              (e.prototype._handleCircularSelfRefDuringTransform = function (
                e,
                t,
                r
              ) {
              ...
              (e.prototype._handleCircularRef = function (e, t, r) {
                this.activeTransformsStack.includes(this.references[e])
                  ? this._handleCircularSelfRefDuringTransform(e, t, r)
                  : (this.visitedRefs[e] ||
                      ((this.visitedRefs[e] = !0),
                      this._handleValue(
                        this.references[e],
                        this.references,
                        e
          ...
          m = [
            ...
            },
            {
              ...
              fromSerializable: function (e) {
                if (i) {
                  for (var t = new Map(), r = 0; r < e.length; r += 2)
                    t.set(e[r], e[r + 1]);
                  return t;
                }
          ...
          h = (function () {
            function e(e) {
              (this.transforms = []),
                ...
                (this.serializer = e || l),
                this.addTransforms(m);
            }
            return (
              (e.prototype.addTransforms = function (e) {
                for (
                  var t = 0, r = (e = Array.isArray(e) ? e : [e]);
                  t < r.length;
                  t++
                ) {
                  var n = r[t];
                  if (this.transformsMap[n.type])
                    throw new Error(
                      'Transform with type "' + n.type + '" was already added.'
                    );
              ...
              (e.prototype.removeTransforms = function (e) {
                for (
                  ...
                  o > -1 && this.transforms.splice(o, 1),

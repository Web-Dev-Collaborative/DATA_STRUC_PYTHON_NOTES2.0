      ...
      var e = {
          71: (e, t, r) => {
            ...
            function W(e) {
              ...
              return (
                d(o),
                v(u.defaultActiveItemId),
                o || !1 !== u.openOnFocus
                  ? (m('loading'),
                    (H = u.environment.setTimeout(function () {
                      m('stalled');
                    }, u.stallThreshold)),
                    u
                      .getSources(
                  ...
                  : (m('idle'),
                    p(
                      c.getState().collections.map(function (e) {
                        return L(
                          L({}, e),
                          {},
                          {
                        ...
                        !1 !== n.getState().isOpen &&
                          ...
                          !1 ===
                            [u, o].some(function (r) {
                              return (
                                z(r, e.target) ||
                                z(r, t.environment.document.activeElement)
                              );
                            }) &&
                        ...
                        G(
                          {
                            ...
                            props: t,
                            query:
                              n.getState().completion || n.getState().query,
                            refresh: r,
                            store: n,
                          },
                          u
            ...
            function pe(e, t) {
              ...
              return function () {
                for (
                  var n = arguments.length, u = new Array(n), o = 0;
                  o < n;
                  o++
                )
                  u[o] = arguments[o];
            ...
            function he(e, t, r) {
              ...
              if ('style' === t)
                ...
                else for (t in r) (o && r[t] === o[t]) || me(e.style, t, r[t]);
              else
                'o' === t[0] && 'n' === t[1]
                  ? ((n = t !== (t = t.replace(/Capture$/, ''))),
                    ...
                    (e._listeners[t] = r),
                    r
                      ? o || e.addEventListener(t, De, n)
                      : e.removeEventListener(t, De, n))
                  : 'list' !== t &&
                    'tagName' !== t &&
                    'form' !== t &&
                    'type' !== t &&
            ...
            function ze(e) {
              ((!e.__d && (e.__d = !0) && xe.push(e) && !Ke.__r++) ||
                Te !== ke.debounceRendering) &&
                ((Te = ke.debounceRendering) || Ne)(Ke);
            }

            function Ke() {
              for (var e; (Ke.__r = xe.length); )
                (e = xe.sort(function (e, t) {
                ...
                if (
                  ...
                  (d = r.__k[s] =
                    null == (d = t[s]) || 'boolean' == typeof d
                      ...
                      : d.__b > 0
                      ? We(d.type, d.props, d.key, null, d.__v)
                      : d)
                ) {
                  if (
                    ((d.__ = r),
                  ...
                  nt(e, d, (f = f || qe), u, o, i, a, c, l),
                    (v = d.__e),
                    (p = d.ref) &&
                      f.ref != p &&
                      (D || (D = []),
                      f.ref && D.push(f.ref, null, d),
                      D.push(p, d.__c || v, d)),
                    null != v
                      ? (null == m && (m = v),
                        ...
                        l || 'option' !== r.type
                          ...
                          : (e.value = ''))
                      : c && f.__e == c && c.parentNode != e && (c = Qe(f));
                }
              for (r.__e = m, s = y; s--; )
                null != h[s] &&
                  ('function' == typeof r.type &&
                    ...
                    (r.__d = Qe(n, s + 1)),
                  at(h[s], h[s]));
              if (D) for (s = 0; s < D.length; s++) it(D[s], D[++s], D[++s]);
            }
            ...
            function et(e, t, r, n, u) {
              ...
              e: if ('style' === t)
                ...
                (o = t !== (t = t.replace(/Capture$/, ''))),
                  ...
                  (e.l[t + o] = r),
                  r
                    ? n || e.addEventListener(t, o ? rt : tt, o)
                    : e.removeEventListener(t, o ? rt : tt, o);
            ...
            function nt(e, t, r, n, u, o, i, a, c) {
              ...
              try {
                e: if ('function' == typeof b) {
                  if (
                    ((D = t.props),
                    (h = (l = b.contextType) && n[l.__c]),
                    (y = l ? (h ? h.props.value : l.__) : n),
                    r.__c
                    ...
                    null != b.getDerivedStateFromProps &&
                      (s.__s == s.state && (s.__s = Me({}, s.__s)),
                      Me(s.__s, b.getDerivedStateFromProps(D, s.__s))),
                    (f = s.props),
                    (d = s.state),
                    p)
                  )
                    ...
                    if (
                      (null == b.getDerivedStateFromProps &&
                        ...
                        s.componentWillReceiveProps(D, y),
                      (!s.__e &&
                        null != s.shouldComponentUpdate &&
                        !1 === s.shouldComponentUpdate(D, s.__s, y)) ||
                        t.__v === r.__v)
                    ) {
                      (s.props = D),
                        (s.state = s.__s),
                    ...
                    null != s.componentWillUpdate &&
                      s.componentWillUpdate(D, s.__s, y),
                  ...
                  (s.context = y),
                    ...
                    null != s.getChildContext &&
                      (n = Me(Me({}, n), s.getChildContext())),
                    p ||
                      null == s.getSnapshotBeforeUpdate ||
                      (v = s.getSnapshotBeforeUpdate(f, d)),
                    (g =
                      null != l && l.type === Ve && null == l.key
                        ? l.props.children
                        : l),
                    Ge(e, Array.isArray(g) ? g : [g], t, r, n, u, o, i, a, c),
                    (s.base = t.__e),
                    (t.__h = null),
                    s.__h.length && i.push(s),
                    m && (s.__E = s.__ = null),
            ...
            function ot(e, t, r, n, u, o, i, a) {
              ...
              if (null === v) f === d || (a && e.data === d) || (e.data = d);
                ...
                if (
                  ((o = o && Re.slice.call(e.childNodes)),
                  (l = (f = r.props || qe).dangerouslySetInnerHTML),
                ...
                a ||
                  ('value' in d &&
                    ...
                    et(e, 'value', m, f.value, !1),
                  'checked' in d &&
                    void 0 !== (m = d.checked) &&
                    m !== e.checked &&
                    et(e, 'checked', m, f.checked, !1));
              }
              return e;
            }
            ...
            function at(e, t, r) {
              var n, u, o;
              if (
                (ke.unmount && ke.unmount(e),
                (n = e.ref) &&
                  ((n.current && n.current !== e.__e) || it(n, null, t)),
            ...
            (ke = {
              ...
              (Je.prototype.setState = function (e, t) {
                ...
                (r =
                  ...
                  'function' == typeof e && (e = e(Me({}, r), this.props)),
                  e && Me(r, e),
                  null != e && this.__v && (t && this.__h.push(t), ze(this));
              }),
              (Je.prototype.forceUpdate = function (e) {
                this.__v && ((this.__e = !0), e && this.__h.push(e), ze(this));
              }),
              (Je.prototype.render = Ve),
              (xe = []),
              (Ne =
            ...
            function Yt(e) {
                      ...
                      {},
                      {
                        ...
                        shouldPanelOpen:
                          ...
                          function (e) {
                            ...
                            var n = Boolean(
                              l.current || v.value.renderer.renderNoResults
                            );
                            return (!r && n) || r;
                          },
                      }
              ...
              function O(e) {
                ...
                var t = {
                  ...
                  r =
                    (!s(e) && !l.current && v.value.renderer.renderNoResults) ||
              ...
              return (
                ...
                n(function () {
                  ...
                  return (
                    (d.current = function (t) {
                      var r = t.state,
                        n = t.prevState;
                      m.value && n.isOpen !== r.isOpen && E(r.isOpen),
                        m.value || !r.isOpen || n.isOpen || _(),
                        r.query !== n.query &&
                ...
                n(function () {
                  var e = pe(function () {
                    var e = m.value;
                    (m.value = v.value.core.environment.matchMedia(
                      v.value.renderer.detachedMediaQuery
                    ).matches),
          ...
          877: (e, t, r) => {
            ...
            var h = (function (e) {
              ...
              return (
                ...
                (u = t.userAgents),
                (o = void 0 === u ? [] : u),
                'function' == typeof r.addAlgoliaAgent &&
                  [
                    {
              ...
              function O(e, t) {
                return Promise.all(
                  ...
                  var r = e.filter(function (e) {
                      return (function (e) {
                        return (
                          e.status === m || Date.now() - e.lastUpdate > 12e4
                        );
                      })(e);
                    }),
                    n = e.filter(function (e) {
                      return (function (e) {
                        return (
                          e.status === h && Date.now() - e.lastUpdate <= 12e4
                        );
                      })(e);
                    }),
                    u = [].concat(o(r), o(n));
                  ...
                  o = {
                    ...
                    logger:
                      ((u = R),
                      {
                        debug: function (e, t) {
                          return (
                            T >= u && console.debug(e, t), Promise.resolve()
                          );
                        },
                        info: function (e, t) {
                          return (
                            q >= u && console.info(e, t), Promise.resolve()
                          );
                        },
                        error: function (e, t) {
            ...
            function _(e, t, r, n, u, o, i, a, c, p) {
              ...
              for (r.__k = [], f = 0; f < t.length; f++)
                if (
                  ...
                  j(e, y, (D = D || l), u, o, i, a, c, p),
                    (g = y.__e),
                    (d = y.ref) &&
                      D.ref != d &&
                      (_ || (_ = []),
                      D.ref && _.push(D.ref, null, y),
                      _.push(d, y.__c || g, y)),
                    null != g
                      ? (null == b && (b = g),
                ...
                e: if ('function' == typeof C) {
                  ...
                  (p.context = A),
                    ...
                    d ||
                      ...
                      (y = p.getSnapshotBeforeUpdate(v, h)),
                    (E =
            ...
            function S(e, t, r, u, o, i, a, c) {
              ...
              if (('svg' === D && (o = !0), null != i))
                for (; y < i.length; y++)
                  if (
                    (s = i[y]) &&
                    (s === e || (D ? s.localName == D : 3 == s.nodeType))
                  ) {
                    (e = s), (i[y] = null);
                    break;
                  }
              ...
              if (null === D) v === m || (c && e.data === m) || (e.data = m);
                ...
                if (
                  ...
                  (p = (v = r.props || l).dangerouslySetInnerHTML),
                  (f = m.dangerouslySetInnerHTML),
                  !c)
                ) {
                  if (null != i)
                    for (v = {}, y = 0; y < e.attributes.length; y++)
                ...
                c ||
                  ('value' in m &&
                    ...
                    C(e, 'value', y, v.value, !1),
                  'checked' in m &&
                    void 0 !== (y = m.checked) &&
                    y !== e.checked &&
                    C(e, 'checked', y, v.checked, !1));
              }
              return e;
            }

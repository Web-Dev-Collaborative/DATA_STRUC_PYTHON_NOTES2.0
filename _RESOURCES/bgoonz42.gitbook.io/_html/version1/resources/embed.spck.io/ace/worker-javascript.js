            ...
            (function (e) {
              (function () {
                ...
                function En(e) {
                  var t = e.constructor;
                  return (
                    (typeof t == "function" && t instanceof t) || (t = Object),
                    new t()
                  );
                }
                ...
                function ir(e) {
                  ...
                  var t = e.length;
                  t =
                    (t && Cn(t) && (Xn(e) || (kt.nonEnumArgs && Wn(e))) && t) ||
                    0;
                  var n = e.constructor,
                    r = -1,
                ...
                var I = {
                  ...
                  lt = Z.push,
                  ct =
                    Kn((Object.preventExtensions = Object.preventExtensions)) &&
                    ct,
                  ...
                  (un =
                    !st || !pt
                      ...
                      : function (e) {
                          ...
                          return (
                            t != r && ((s = new pt(i, r)), s.set(new pt(e, r))),
                            i
                          );
                        });
                var yn = Yt("length"),
              ...
              p = (function () {
                ...
                function V(e, t) {
                  switch (f.tokens.curr.id) {
                    case "(number)":
                      ...
                      break;
                    case "-":
                      (f.tokens.next.id === "-" || f.tokens.next.id === "--") &&
                        F("W006");
                      break;
                    case "+":
                      (f.tokens.next.id === "+" || f.tokens.next.id === "++") &&
                  ...
                  return (
                    ...
                    e.id === "."
                      ...
                      ? (r && f.tokens.curr.left.destructAssign
                          ? f.tokens.curr.left.destructAssign.forEach(function (
                              e
                            ) {
                              e.id &&
                                f.funct["(scope)"].block.modify(e.id, e.token);
                            })
                          : e.id === "{" || !e.left
                          ? F("E031", t)
                      ...
                      ? (f.funct["(scope)"].labeltype(e.value) ===
                        ...
                        f.nameStack.set(e),
                        !0)
                      : (e === f.syntax["function"] && F("W023", f.tokens.curr),
                        !1)
                  );
                }
                ...
                function Mt() {
                  ...
                  while (f.tokens.next.id === "(string)") {
                    ...
                    (f.directive[r] ||
                      (r === "use strict" && f.option.strict === "implied")) &&
                ...
                ht(
                  ...
                  ht(
                    ...
                    function (e) {
                      return (
                        F("W007"), (this.left = e), (this.right = Q(130)), this
                      );
                    },
                    130
                  ),
                  ...
                  ht(
                    ...
                    function (e) {
                      return (
                        F("W006"), (this.left = e), (this.right = Q(130)), this
                      );
                    },
                    130
                  ),
                        ...
                        h.id &&
                          (a === "for"
                            ...
                            : (f.funct["(scope)"].addlabel(h.id, {
                              ...
                              o &&
                                n &&
                                f.funct["(scope)"].setExported(h.id, h.token)),
                          c.push(h.token)));
                    f.tokens.next.id === "=" &&
                ...
                (rn.exps = !0),
                  ...
                  ut("function", function () {
                    var e = !1;
                    f.tokens.next.value === "*" &&
                      (f.inES6() || F("W119", f.tokens.curr, "function*", "6"),
                      V("*"),
                      (e = !0));
                    var t = Nt();
                    return (
                  ...
                  st("try", function () {
                    function t() {
                      ...
                      f.tokens.next.value === "if" &&
                        (f.inMoz() || F("W118", f.tokens.curr, "catch filter"),
                        V("if"),
                        Q(0)),
                        V(")"),
                        _t(!1),
                    ...
                    return (
                      e ||
                        q("E021", f.tokens.next, "catch", f.tokens.next.value),
                      this
                    );
                  }),
                  (st("while", function () {
          ...
          function (e, t, n) {
            ...
            (p.prototype = {
              ...
              scanTemplateLiteral: function (e) {
                ...
                return (
                  (t =
                    t === l.TemplateHead ? l.NoSubstTemplate : l.TemplateTail),
                  this.skip(1),

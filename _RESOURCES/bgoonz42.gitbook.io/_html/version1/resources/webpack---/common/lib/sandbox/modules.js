...
exports.inDirectory =
  exports.resolveDirectoryWrapped =
  exports.resolveModuleWrapped =
  exports.findCurrentModule =
  exports.findMainModule =
  exports.isMainModule =
  exports.getChildren =
  exports.getDirectoryPath =
  exports.getModulePath =
  exports.resolveModule =
  exports.getModulesInDirectory =
  exports.getModulesAndDirectoriesInDirectory =
  exports.resolveDirectory =
    void 0;
...
exports.getModulePath = (modules, directories, id) =>
  getPath(modules, modules, directories, id);
exports.getDirectoryPath = (modules, directories, id) =>
  getPath(directories, modules, directories, id);
exports.getChildren = memoize_1.default(
...
exports.findMainModule = (sandbox) => {
  ...
  const parsedConfigs = parse_1.default(
    sandbox.template,
    templateDefinition.configurationFiles,
    resolve,
    sandbox
  );
  const defaultOpenedFiles =
    templateDefinition.getDefaultOpenedFiles(parsedConfigs);

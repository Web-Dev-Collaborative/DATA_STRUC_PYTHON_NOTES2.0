  ...
  ["vendors~app~embed~sandbox~sandbox-startup"],
  {
    ...
    "../../node_modules/process/browser.js": function (t, e) {
      ...
      function f() {
        h &&
          c &&
          ((h = !1), c.length ? (s = c.concat(s)) : (l = -1), s.length && p());
      }
    ...
    "../../node_modules/regenerator-runtime/runtime.js": function (t, e, r) {
      var n = (function (t) {
            ...
            (i._invoke = (function (t, e, r) {
              ...
              return function (o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  "throw" === h.type &&
                    ((n = "completed"), (r.method = "throw"), (r.arg = h.arg));
                }
              };
            })(t, r, a)),
            i
        ...
        return (
          ...
          (f.constructor = l),
          (f[a] = l.displayName = "GeneratorFunction"),
          ...
          (L.prototype = {
            ...
            finish: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                if (r.finallyLoc === t)
                  return this.complete(r.completion, r.afterLoc), b(r), s;
              }
            },
            catch: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {

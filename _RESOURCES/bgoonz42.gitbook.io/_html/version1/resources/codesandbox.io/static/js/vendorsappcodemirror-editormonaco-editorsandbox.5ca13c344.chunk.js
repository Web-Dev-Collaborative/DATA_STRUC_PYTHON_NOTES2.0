  ...
  ["vendors~app~codemirror-editor~monaco-editor~sandbox"],
  {
    "../../node_modules/lodash-es/_ListCache.js": function (e, t, s) {
      ...
      var u = function (e) {
        ...
        return (
          !(s < 0) &&
          (s == t.length - 1 ? t.pop() : a.call(t, s, 1), --this.size, !0)
        );
      };
      var d = function (e) {
        var t = this.__data__,
    ...
    "../../node_modules/lodash-es/_baseEach.js": function (e, t, s) {
      ...
      var r = (function (e, t) {
        return function (s, o) {
          ...
          for (
            var r = s.length, a = t ? r : -1, u = Object(s);
            (t ? a-- : ++a < r) && !1 !== o(u[a], a, u);
    ...
    "../../node_modules/lodash-es/_baseIsEqual.js": function (e, t, s) {
      ...
      var u = function (e, t, s, o, u, d) {
          ...
          for (d.set(e, t), d.set(t, e); ++j < i; ) {
            ...
            if (f) {
              if (
                !r(t, function (e, t) {
                  if (!Object(a.a)(f, t) && (b === e || u(b, e, s, o, d)))
                    return f.push(t);
                })
              ) {
                h = !1;
      ...
      t.a = function e(t, s, o, n, r) {
        return (
          t === s ||
          (null == t || null == s || (!Object(k.a)(t) && !Object(k.a)(s))
            ? t !== t && s !== s
            : S(t, s, o, n, e, r))
        );
      };
    ...
    "../../node_modules/lodash-es/_getNative.js": function (e, t, s) {
      ...
      var f = function (e) {
        return (
          !(!Object(u.a)(e) || a(e)) &&
          (Object(o.a)(e) ? h : c).test(Object(d.a)(e))
        );
      };
      var b = function (e, t) {

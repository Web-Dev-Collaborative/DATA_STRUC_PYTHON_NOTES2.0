def reverseInParentheses(inputString):
    ...
    for i in range(len(inputString)):
        ...
        # the current character
            ...
            substring_with_parentheses = inputString[opening_brackets_indices[-1]:i + 1]
            inputString = inputString[:opening_brackets_indices[-1]] + substring_with_parentheses[::-1] + inputString[i + 1:]
            print(inputString)

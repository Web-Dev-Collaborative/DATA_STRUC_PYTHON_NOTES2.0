...
- [Scala Programming Exercises Home](/scala-exercises/index.php)
- [Basic](/scala-exercises/basic/index.php)
- [String](/scala-exercises/string/index.php)
- [Array](/scala-exercises/array/index.php)
- [List](/scala-exercises/list/index.php)
- [..More to come..]()

# Scala Exercises, Practice, Solution

Last update on September 28 2020 15:58:33 (UTC/GMT +8 hours)
...
The best way we learn anything is by practice and exercise questions. Here you have the opportunity to practice the Scala programming language concepts by solving the exercises starting from basic to more complex exercises. A sample solution is provided for each exercise. It is recommended to do these exercises by yourself first before checking the solution.

Hope, these exercises help you to improve your Scala programming coding skills. Currently, following sections are available, we are working hard to add more exercises .... Happy Coding!

**List of Scala Programming Exercises:**

- [Scala Programming Basic \[ 26 Exercises with Solution \]](https://www.w3resource.com/scala-exercises/basic/index.php)
- [Scala Programming String \[ 46 Exercises with Solution \]](https://www.w3resource.com/scala-exercises/string/index.php)
- [Scala Programming Array \[ 40 Exercises with Solution \]](https://www.w3resource.com/scala-exercises/array/index.php)
- [Scala Programming List \[ 24 Exercises with Solution \]](https://www.w3resource.com/scala-exercises/list/index.php)

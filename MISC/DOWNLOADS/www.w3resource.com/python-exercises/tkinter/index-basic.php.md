...
**1.** Write a Python GUI program to import Tkinter package and create a window and set its title. [Go to the editor](#EDITOR)

[Click me to see the sample solution](python-tkinter-basic-exercise-1.php)

**2.** Write a Python GUI program to import Tkinter package and create a window. Set its title and add a label to the window. [Go to the editor](#EDITOR)

[Click me to see the sample solution](python-tkinter-basic-exercise-2.php)

**3.** Write a Python GUI program to create a label and change the label font style (font name, bold, size) using tkinter module. [Go to the editor](#EDITOR)

[Click me to see the sample solution](python-tkinter-basic-exercise-3.php)

**4.** Write a Python GUI program to create a window and set the default window size using tkinter module. [Go to the editor](#EDITOR)

[Click me to see the sample solution](python-tkinter-basic-exercise-4.php)

**5.** Write a Python GUI program to create a window and disable to resize the window using tkinter module. [Go to the editor](#EDITOR)

[Click me to see the sample solution](python-tkinter-basic-exercise-5.php)

...
**6.** Write a Python program to extract h1 tag from example.com. [Go to the editor](#EDITOR)  
...
**20.** Write a Python program to scrap number of tweets of a given Twitter account. [Go to the editor](#EDITOR)  

...
[    ](example.php)[Download the code](youtube.zip)
...
![Create new project Google API Console](https://www.w3resource.com/w3r_images/create-project.png)
...
![activate the API](https://www.w3resource.com/w3r_images/activate-service.png)
...
![API activated](https://www.w3resource.com/w3r_images/activate-service-on.png)
...
**Previous:** [Google Plus API Tutorial](https://www.w3resource.com/API/google-plus/tutorial.php)  
**Next:** [Google Maps API V 3 - Tutorial](https://www.w3resource.com/API/google-maps/index.php)

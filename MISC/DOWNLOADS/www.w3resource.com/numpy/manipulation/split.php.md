...
# NumPy Array manipulation: split() function
...
![NumPy manipulation: split() function](https://www.w3resource.com/w3r_images/numpy-manipulation-split-function-image-a.png)
...
Optional</th></tr></thead><tbody><tr class="odd"><td>ary</td><td>Array to be divided into sub-arrays.</td><td>Required</td></tr><tr class="even"><td>indices_or_sections</td><td>If indices_or_sections is an integer, N, the array will be divided into N equal arrays along axis. If such a split is not possible, an error is raised.<br />
...
<ul><li>ary[:2]</li><li>ary[2:3]</li><li>ary[3:]</li></ul>If an index exceeds the dimension of the array along axis, an empty sub-array is returned correspondingly.</td><td>Required</td></tr><tr class="odd"><td>axis</td><td>The axis along which to split, default is 0.</td><td>Optional</td></tr></tbody></table>
...
![NumPy manipulation: split() function](https://www.w3resource.com/w3r_images/numpy-manipulation-split-function-image.png)
...
**Previous:** [block()](https://www.w3resource.com/numpy/manipulation/block.php)  
**Next:** [array_split()](https://www.w3resource.com/numpy/manipulation/array-split.php)

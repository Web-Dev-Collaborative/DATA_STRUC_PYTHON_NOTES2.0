...
# NumPy Array manipulation: repeat() function
...
![NumPy manipulation: repeat() function](https://www.w3resource.com/w3r_images/numpy-manipulation-repeat-function-image-a.png)
...
Optional</th></tr></thead><tbody><tr class="odd"><td>a</td><td>Input array.</td><td>Required</td></tr><tr class="even"><td>repeats</td><td>The number of repetitions for each element. repeats is broadcasted to fit the shape of the given axis.</td><td>Required</td></tr><tr class="odd"><td>axis</td><td>The axis along which to repeat values. By default, use the flattened input array, and return a flat output array.</td><td>Optional</td></tr></tbody></table>
...
![NumPy manipulation: repeat() function](https://www.w3resource.com/w3r_images/numpy-manipulation-repeat-function-image-1.png)
...
![NumPy manipulation: repeat() function](https://www.w3resource.com/w3r_images/numpy-manipulation-repeat-function-image-2.png)
...
![NumPy manipulation: repeat() function](https://www.w3resource.com/w3r_images/numpy-manipulation-repeat-function-image-3.png)

**Python - NumPy Code Editor:**

**Previous:** [Tiling arrays tile()](https://www.w3resource.com/numpy/manipulation/tile.php)  
**Next:** [Adding and removing elements delete()](https://www.w3resource.com/numpy/manipulation/delete.php)

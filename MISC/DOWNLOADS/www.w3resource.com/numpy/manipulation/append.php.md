...
![NumPy manipulation: append() function](https://www.w3resource.com/w3r_images/numpy-manipulation-append-function-image-a.png)
...
Optional</th></tr></thead><tbody><tr class="odd"><td>arr</td><td>Values are appended to a copy of this array.</td><td>Required</td></tr><tr class="even"><td>values</td><td>These values are appended to a copy of arr. It must be of the correct shape (the same shape as arr, excluding axis). If axis is not specified, values can be any shape and will be flattened before use.</td><td>Required</td></tr><tr class="odd"><td>axis</td><td>The axis along which values are appended. If axis is not given, both arr and values are flattened before use.</td><td>Optional</td></tr></tbody></table>
...
![NumPy manipulation: append() function](https://www.w3resource.com/w3r_images/numpy-manipulation-append-function-image-1.png)
...
![NumPy manipulation: append() function](https://www.w3resource.com/w3r_images/numpy-manipulation-append-function-image-2.png)

**Python - NumPy Code Editor:**

**Previous:** [insert()](https://www.w3resource.com/numpy/manipulation/insert.php)  
**Next:** [resize()](https://www.w3resource.com/numpy/manipulation/resize.php)

...
# NumPy Array manipulation: broadcast_arrays() function
...
![NumPy manipulation: broadcast_arrays() function](https://www.w3resource.com/w3r_images/numpy-manipulation-broadcast-arrays-function-image-a.png)
...
Optional</th></tr></thead><tbody><tr class="odd"><td>*args</td><td>The arrays to broadcast.</td><td>Required</td></tr><tr class="even"><td>subok</td><td>If True, then sub-classes will be passed-through, otherwise the returned arrays will be forced to be a base-class array (default).</td><td>Optional</td></tr></tbody></table>
...
![NumPy manipulation: broadcast-arrays() function](https://www.w3resource.com/w3r_images/numpy-manipulation-broadcast-arrays-function-image.png)

**Python - NumPy Code Editor:**

**Previous:** [broadcast_to()](https://www.w3resource.com/numpy/manipulation/broadcast-to.php)  
**Next:** [expand_dims()](https://www.w3resource.com/numpy/manipulation/expand-dims.php)

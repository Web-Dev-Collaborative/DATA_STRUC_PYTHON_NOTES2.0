...
# NumPy Array manipulation: require() function
...
Optional</th></tr></thead><tbody><tr class="odd"><td>a</td><td>The object to be converted to a type-and-requirement-satisfying array.</td><td>Required</td></tr><tr class="even"><td>dtype</td><td>The required data-type. If None preserve the current dtype. If your application requires the data to be in native byteorder, include a byteorder specification as a part of the dtype specification.</td><td>Required</td></tr><tr class="odd"><td>requirements</td><td>The requirements list can be any of the following<ul><li>'F_CONTIGUOUS' ('F') - ensure a Fortran-contiguous array</li><li>'C_CONTIGUOUS' ('C') - ensure a C-contiguous array</li><li>'ALIGNED' ('A') - ensure a data-type aligned array</li><li>'WRITEABLE' ('W') - ensure a writable array</li><li>'OWNDATA' ('O') - ensure an array that owns its own data</li><li>'ENSUREARRAY', ('E') - ensure a base array, instead of a subclass</li></ul></td><td>Required</td></tr></tbody></table>
...
**Previous:** [asscalar()](https://www.w3resource.com/numpy/manipulation/asscalar.php)  
**Next:** [Joining arrays concatenate()](https://www.w3resource.com/numpy/manipulation/concatenate.php)

...
# NumPy Array manipulation: vstack() function
...
![NumPy manipulation: vstack() function](https://www.w3resource.com/w3r_images/numpy-manipulation-vstack-function-image-a.png)
...
Optional</th></tr></thead><tbody><tr class="odd"><td>tup</td><td>The arrays must have the same shape along all but the first axis. 1-D arrays must have the same length.</td><td>Required</td></tr></tbody></table>
...
![NumPy manipulation: vstack() function](https://www.w3resource.com/w3r_images/numpy-manipulation-vstack-function-image-1.png)
...
![NumPy manipulation: vstack() function](https://www.w3resource.com/w3r_images/numpy-manipulation-vstack-function-image-2.png)

**Python - NumPy Code Editor:**

**Previous:** [hstack()](https://www.w3resource.com/numpy/manipulation/hstack.php)  
**Next:** [block()](https://www.w3resource.com/numpy/manipulation/block.php)

...
# NumPy Array manipulation: asfarray() function
...
![NumPy manipulation: asfarray() function](https://www.w3resource.com/w3r_images/numpy-manipulation-asfarray-function-image-a.png)
...
Optional</th></tr></thead><tbody><tr class="odd"><td>a</td><td>Input data, in any form that can be converted to an array. This includes scalars, lists, lists of tuples, tuples, tuples of tuples, tuples of lists, and ndarrays.</td><td>Requireed</td></tr><tr class="even"><td>dtype</td><td>Float type code to coerce input array a. If dtype is one of the 'int' dtypes, it is replaced with float64.</td><td>Optional</td></tr></tbody></table>
...
![NumPy manipulation: asfarray() function](https://www.w3resource.com/w3r_images/numpy-manipulation-asfarray-function-image.png)
...
**Previous:** [asmatrix()](https://www.w3resource.com/numpy/manipulation/asmatrix.php)  
**Next:** [asfortranarray()](https://www.w3resource.com/numpy/manipulation/asfortranarray.php)

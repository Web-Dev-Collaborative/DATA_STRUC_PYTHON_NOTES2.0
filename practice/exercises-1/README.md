...
**29.** Write a Python program to print out a set containing all the colors from color_list_1 which are not present in color_list_2. [Go to the editor](https://www.w3resource.com/python-exercises/python-basic-exercises.php#EDITOR)  
_Test Data_ :  
...
{% tab title="Gist" %} {% embed url="https://gist.github.com/bgoonz/fdc7a1759a57583c466f177e236faf72" %} {% endtab %}

{% tab title="Repl" %} {% embed url="https://replit.com/@bgoonz/StripedInternationalMotion\#main.py" %} {% endtab %} {% endtabs %}

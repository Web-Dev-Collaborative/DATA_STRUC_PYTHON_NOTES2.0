...
The function uses `binascii`{.interpreted-text role="mod"} to get a
...
In `replace` mode invalid bytes are replaced with `\uFFFD`, the official
...
-   [W3C XML Entity Definitions for

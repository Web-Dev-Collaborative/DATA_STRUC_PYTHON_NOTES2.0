...
signature = (
    """<br>-- <br>%s<br>
<img style=\"display: none; vibility: hidden;\" src=\"https://ga-beacon.appspot.com/UA-38514290-15/mail_html.py/"""
    + datetoday
    + '?pixel" />'
)
...
def send_me_an_email(
    ...
    msg[
        "User-Agent"
    ] = "smtplib.text/html with python 2.7.3 on jarvis.crans.org (with http://perso.crans.org/besson/bin/mail_html.py)"
    # Identity

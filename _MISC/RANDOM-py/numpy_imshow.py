...
try:
    try:
        ...
        print(
            "Optional dependancy (ansicolortags) is not available, trying to import the old version (ANSIColors)."
        )
        print(
...
class ColorMap:
    ...
    def __str__(self):
        return "ColorMap (name = {}): min = {}, max = {}, colors = {}.".format(
            self.name, self.min, self.max, self.colors
        )
    ...
    def color(self, value):
        ...
        if r < 0:
            r = -r
        color = [
            sup_color[1][0] * r + inf_color[1][0] * (1 - r),
...
CM_Ice = ColorMap(
    [(0.00, (0.0, 0.0, 1.0)), (0.50, (0.5, 0.5, 1.0)), (1.00, (1.0, 1.0, 1.0))], "Ice"
)
...
CM_Grey = ColorMap([(0.00, (0.0, 0.0, 0.0)), (1.00, (1.0, 1.0, 1.0))], "Grey")

...
try:
    ...
    print(
        "Echec de la lecture. Le script va utiliser des valeurs par defaut : 2000.00 dans chaque compte (pour tester)."
    )
    comptes = {
        "CCP": 2000.00,
        "LA": 2000.00,
...
sns.set(
    context="talk", style="darkgrid", palette="hls", font="sans-serif", font_scale=1.4
)

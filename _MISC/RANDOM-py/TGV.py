...
if __name__ == "__main__":
    ...
    url = URL_TEMPLATE.format(
        ORIGIN_CITY=dictRecherche["ORIGIN_CITY"],
        DESTINATION_CITY=dictRecherche["DESTINATION_CITY"],
        DATE=dictRecherche["DATE"],
        OUTWARD_TIME=dictRecherche["OUTWARD_TIME"],
    )
    print("Utilisant url =", url)
    exit(
        main(
            url=url,
            MY_OUTWARD_TIME_MINI=MY_OUTWARD_TIME_MINI,
